...
/** 
 * Represents a "forest" graph that contains a Collection
 * of trees.
 * 
 * @author wirthlin
 */
public interface GraphForest extends DirectedGraph {
	...
	/** Return the trees that compose this forest. Each
	 * object in this collection is an DirectedGraph object.
	 * @return
	 */
