 ...
 * and a Collection of Edge objects. The node objects can be a class of any
 * type while the edge objects within the Collections must be an Edge
 * object.
 * 
...
public class NodeEdgeMap extends HashMap implements Cloneable {
	 ...
	 * @param sourceMapped The mapping mode of the object.
	 * true indicates a "source" mapped mapping while false
	 * indicates a "sink" mapped mapping.
	 */
	 ...
	 *        "source" mapped mapping while false indicates a "sink" mapped
	 *        mapping.
	 */
	 ...
	 *         If the map returns a null, this method will return an empty but
	 *         non-null Collection.
	 */
