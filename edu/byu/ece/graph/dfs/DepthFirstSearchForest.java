...
public class DepthFirstSearchForest implements GraphForest {
    ...
    /**
	 * Search all the DepthFirstTree objects in the current DepthFirstSearch object
	 * for the given node and return true if found.
	 * 
	...
	protected void _search(List nodesInorder) {
	    ...
	    while (i.hasNext()) {
			 ...
			 */
			/*
			if (_invert && _graph.hasPredecessors(node) ||
			    !_invert && _graph.hasSuccessors(node))
