/*
 * Generates the EDIF file for RAM16X8S
 *
...
/**
 * Generates the EDIF file for RAM16X8S
 * Includes: 128 FDEs, 8 16-1 MUXs(9 LUT3s, 4 MUXF5s, and 2 MUXF6s for each), 1 4-16 decoder(2 LUT2s, 16 LUT4s).
 * 
 * @author Yubo Li
 *
 */

public class RAM16X8S_replacement{
	public static void main(String args[]){
		
		String outputFileName = "RAM16X8S_replacement.edf";
		
		try{
			/******Environment and Environment manager******/
			EdifEnvironment topLevel = new EdifEnvironment("RAM16X8S_replacement");
			...
			try{
				...
				EdifCell RAM16X8S_replacement = new EdifCell(work, "RAM16X8S_replacement");
				RAM16X8S_replacement.addPort("WE", 1, 1);
				RAM16X8S_replacement.addPort("D", 8, 1);
				RAM16X8S_replacement.addPort("WCLK", 1, 1);
				RAM16X8S_replacement.addPort("A0", 1, 1);
				RAM16X8S_replacement.addPort("A1", 1, 1);
				RAM16X8S_replacement.addPort("A2", 1, 1);
				RAM16X8S_replacement.addPort("A3", 1, 1);
				RAM16X8S_replacement.addPort("O", 8, 2);
				
				/******Design******/
				EdifDesign design = new EdifDesign("RAM16X8S_replacement");
				topLevel.setTopDesign(design);
				topLevel.setTopCell(RAM16X8S_replacement);
				...
				EdifNet wclk_c = new EdifNet("wclk_c", RAM16X8S_replacement);
				EdifNet wclk = new EdifNet("wclk", RAM16X8S_replacement);
				EdifNet d0_c = new EdifNet("d0_c", RAM16X8S_replacement);
				EdifNet d0 = new EdifNet("d0", RAM16X8S_replacement);
				EdifNet d1_c = new EdifNet("d1_c", RAM16X8S_replacement);
				EdifNet d1 = new EdifNet("d1", RAM16X8S_replacement);
				EdifNet d2_c = new EdifNet("d2_c", RAM16X8S_replacement);
				EdifNet d2 = new EdifNet("d2", RAM16X8S_replacement);
				EdifNet d3_c = new EdifNet("d3_c", RAM16X8S_replacement);
				EdifNet d3 = new EdifNet("d3", RAM16X8S_replacement);
				EdifNet d4_c = new EdifNet("d4_c", RAM16X8S_replacement);
				EdifNet d4 = new EdifNet("d4", RAM16X8S_replacement);
				EdifNet d5_c = new EdifNet("d5_c", RAM16X8S_replacement);
				EdifNet d5 = new EdifNet("d5", RAM16X8S_replacement);
				EdifNet d6_c = new EdifNet("d6_c", RAM16X8S_replacement);
				EdifNet d6 = new EdifNet("d6", RAM16X8S_replacement);
				EdifNet d7_c = new EdifNet("d7_c", RAM16X8S_replacement);
				EdifNet d7 = new EdifNet("d7", RAM16X8S_replacement);
				EdifNet we_c = new EdifNet("we_c", RAM16X8S_replacement);
				EdifNet we = new EdifNet("we", RAM16X8S_replacement);
				EdifNet a0_c = new EdifNet("a0_c", RAM16X8S_replacement);
				EdifNet a0 = new EdifNet("a0", RAM16X8S_replacement);
				EdifNet a1_c = new EdifNet("a1_c", RAM16X8S_replacement);
				EdifNet a1 = new EdifNet("a1", RAM16X8S_replacement);
				EdifNet a2_c = new EdifNet("a2_c", RAM16X8S_replacement);
				EdifNet a2 = new EdifNet("a2", RAM16X8S_replacement);
				EdifNet a3_c = new EdifNet("a3_c", RAM16X8S_replacement);
				EdifNet a3 = new EdifNet("a3", RAM16X8S_replacement);
				EdifNet o0_c = new EdifNet("o0_c", RAM16X8S_replacement);
				EdifNet o0 = new EdifNet("o0", RAM16X8S_replacement);
				EdifNet o1_c = new EdifNet("o1_c", RAM16X8S_replacement);
				EdifNet o1 = new EdifNet("o1", RAM16X8S_replacement);
				EdifNet o2_c = new EdifNet("o2_c", RAM16X8S_replacement);
				EdifNet o2 = new EdifNet("o2", RAM16X8S_replacement);
				EdifNet o3_c = new EdifNet("o3_c", RAM16X8S_replacement);
				EdifNet o3 = new EdifNet("o3", RAM16X8S_replacement);
				EdifNet o4_c = new EdifNet("o4_c", RAM16X8S_replacement);
				EdifNet o4 = new EdifNet("o4", RAM16X8S_replacement);
				EdifNet o5_c = new EdifNet("o5_c", RAM16X8S_replacement);
				EdifNet o5 = new EdifNet("o5", RAM16X8S_replacement);
				EdifNet o6_c = new EdifNet("o6_c", RAM16X8S_replacement);
				EdifNet o6 = new EdifNet("o6", RAM16X8S_replacement);
				EdifNet o7_c = new EdifNet("o7_c", RAM16X8S_replacement);
				EdifNet o7 = new EdifNet("o7", RAM16X8S_replacement);
				...
				for(int i=0; i<WIRENUM; i++)
				{
					...
					wire[i] = new EdifNet(wirename, RAM16X8S_replacement);
				}
				...
				for(int i=0; i<NETNUM; i++)
				{
					...
					net[i] = new EdifNet(netname, RAM16X8S_replacement);
				}
				...
				for(int i=0; i<ENUM; i++)
				{
					...
					e[i] = new EdifNet(ename, RAM16X8S_replacement);
				}
				//Add all nets to the top level design
				RAM16X8S_replacement.addNet(wclk_c);
				RAM16X8S_replacement.addNet(wclk);
				RAM16X8S_replacement.addNet(d0_c);
				RAM16X8S_replacement.addNet(d0);
				RAM16X8S_replacement.addNet(d1_c);
				RAM16X8S_replacement.addNet(d1);
				RAM16X8S_replacement.addNet(d2_c);
				RAM16X8S_replacement.addNet(d2);
				RAM16X8S_replacement.addNet(d3_c);
				RAM16X8S_replacement.addNet(d3);
				RAM16X8S_replacement.addNet(d4_c);
				RAM16X8S_replacement.addNet(d4);
				RAM16X8S_replacement.addNet(d5_c);
				RAM16X8S_replacement.addNet(d5);
				RAM16X8S_replacement.addNet(d6_c);
				RAM16X8S_replacement.addNet(d6);
				RAM16X8S_replacement.addNet(d7_c);
				RAM16X8S_replacement.addNet(d7);
				RAM16X8S_replacement.addNet(we_c);
				RAM16X8S_replacement.addNet(we);
				RAM16X8S_replacement.addNet(a0_c);
				RAM16X8S_replacement.addNet(a0);
				RAM16X8S_replacement.addNet(a1_c);
				RAM16X8S_replacement.addNet(a1);
				RAM16X8S_replacement.addNet(a2_c);
				RAM16X8S_replacement.addNet(a2);
				RAM16X8S_replacement.addNet(a3_c);
				RAM16X8S_replacement.addNet(a3);
				RAM16X8S_replacement.addNet(o0_c);
				RAM16X8S_replacement.addNet(o0);
				RAM16X8S_replacement.addNet(o1_c);
				RAM16X8S_replacement.addNet(o1);
				RAM16X8S_replacement.addNet(o2_c);
				RAM16X8S_replacement.addNet(o2);
				RAM16X8S_replacement.addNet(o3_c);
				RAM16X8S_replacement.addNet(o3);
				RAM16X8S_replacement.addNet(o4_c);
				RAM16X8S_replacement.addNet(o4);
				RAM16X8S_replacement.addNet(o5_c);
				RAM16X8S_replacement.addNet(o5);
				RAM16X8S_replacement.addNet(o6_c);
				RAM16X8S_replacement.addNet(o6);
				RAM16X8S_replacement.addNet(o7_c);
				RAM16X8S_replacement.addNet(o7);
				for(int i=0; i<WIRENUM; i++)
				{
					RAM16X8S_replacement.addNet(wire[i]);
				}
				for(int i=0; i<NETNUM; i++)
				{
					RAM16X8S_replacement.addNet(net[i]);
				}
				for(int i=0; i<ENUM; i++)
				{
					RAM16X8S_replacement.addNet(e[i]);
				}
				...
				EdifCellInstance WE_ibuf = new EdifCellInstance("WE_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D0_ibuf = new EdifCellInstance("D0_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D1_ibuf = new EdifCellInstance("D1_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D2_ibuf = new EdifCellInstance("D2_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D3_ibuf = new EdifCellInstance("D3_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D4_ibuf = new EdifCellInstance("D4_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D5_ibuf = new EdifCellInstance("D5_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D6_ibuf = new EdifCellInstance("D6_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance D7_ibuf = new EdifCellInstance("D7_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance WCLK_ibuf = new EdifCellInstance("WCLK_ibuf", RAM16X8S_replacement, BUFGP);
				EdifCellInstance A0_ibuf = new EdifCellInstance("A0_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance A1_ibuf = new EdifCellInstance("A1_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance A2_ibuf = new EdifCellInstance("A2_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance A3_ibuf = new EdifCellInstance("A3_ibuf", RAM16X8S_replacement, IBUF);
				EdifCellInstance O0_obuf = new EdifCellInstance("O0_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O1_obuf = new EdifCellInstance("O1_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O2_obuf = new EdifCellInstance("O2_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O3_obuf = new EdifCellInstance("O3_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O4_obuf = new EdifCellInstance("O4_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O5_obuf = new EdifCellInstance("O5_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O6_obuf = new EdifCellInstance("O6_obuf", RAM16X8S_replacement, OBUF);
				EdifCellInstance O7_obuf = new EdifCellInstance("O7_obuf", RAM16X8S_replacement, OBUF);
				//FDEs
				...
				for(int i=0; i<FDENUM; i++)
				{
					...
					FDE_[i] = new EdifCellInstance(fdename, RAM16X8S_replacement, FDE);
				}
				//LUT2s
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_[i] = new EdifCellInstance(lut2name, RAM16X8S_replacement, LUT2);
				}
				//LUT3s
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					LUT3_[i] = new EdifCellInstance(lut3name, RAM16X8S_replacement, LUT3);
				}
				//LUT4s
				...
				for(int i=0; i<LUT4NUM; i++)
				{
					...
					LUT4_[i] = new EdifCellInstance(lut4name, RAM16X8S_replacement, LUT4);
				}
				//MUXF5
				...
				for(int i=0; i<MUXF5NUM; i++)
				{
					...
					MUXF5_[i] = new EdifCellInstance(muxf5name, RAM16X8S_replacement, MUXF5);
				}
				//MUXF6
				...
				for(int i=0; i<MUXF6NUM; i++)
				{
					...
					MUXF6_[i] = new EdifCellInstance(muxf6name, RAM16X8S_replacement, MUXF6);
				}
				//Add all instances to the top level design
				RAM16X8S_replacement.addSubCell(WE_ibuf);
				RAM16X8S_replacement.addSubCell(D0_ibuf);
				RAM16X8S_replacement.addSubCell(D1_ibuf);
				RAM16X8S_replacement.addSubCell(D2_ibuf);
				RAM16X8S_replacement.addSubCell(D3_ibuf);
				RAM16X8S_replacement.addSubCell(D4_ibuf);
				RAM16X8S_replacement.addSubCell(D5_ibuf);
				RAM16X8S_replacement.addSubCell(D6_ibuf);
				RAM16X8S_replacement.addSubCell(D7_ibuf);
				RAM16X8S_replacement.addSubCell(WCLK_ibuf);
				RAM16X8S_replacement.addSubCell(A0_ibuf);
				RAM16X8S_replacement.addSubCell(A1_ibuf);
				RAM16X8S_replacement.addSubCell(A2_ibuf);
				RAM16X8S_replacement.addSubCell(A3_ibuf);
				RAM16X8S_replacement.addSubCell(O0_obuf);
				RAM16X8S_replacement.addSubCell(O1_obuf);
				RAM16X8S_replacement.addSubCell(O2_obuf);
				RAM16X8S_replacement.addSubCell(O3_obuf);
				RAM16X8S_replacement.addSubCell(O4_obuf);
				RAM16X8S_replacement.addSubCell(O5_obuf);
				RAM16X8S_replacement.addSubCell(O6_obuf);
				RAM16X8S_replacement.addSubCell(O7_obuf);
				for(int i=0; i<FDENUM; i++)
				{
					RAM16X8S_replacement.addSubCell(FDE_[i]);
				}
				for(int i=0; i<LUT2NUM; i++)
				{
					RAM16X8S_replacement.addSubCell(LUT2_[i]);
				}
				for(int i=0; i<LUT3NUM; i++)
				{
					RAM16X8S_replacement.addSubCell(LUT3_[i]);
				}
				for(int i=0; i<LUT4NUM; i++)
				{
					RAM16X8S_replacement.addSubCell(LUT4_[i]);
				}
				for(int i=0; i<MUXF5NUM; i++)
				{
					RAM16X8S_replacement.addSubCell(MUXF5_[i]);
				}
				for(int i=0; i<MUXF6NUM; i++)
				{
					RAM16X8S_replacement.addSubCell(MUXF6_[i]);
				}
				
				/******Interface******/
				//Interface of buffers
				EdifCellInterface RAM16X8S_replacement_interface = new EdifCellInterface(RAM16X8S_replacement);
				...
				/******Ports******/
				//RAM16X8S_replacement
				EdifPort RAM16X8S_replacement_interface_WE = new EdifPort(RAM16X8S_replacement_interface, "WE", 1, 1);
				EdifPort RAM16X8S_replacement_interface_D = new EdifPort(RAM16X8S_replacement_interface, "D", 8, 1);
				EdifPort RAM16X8S_replacement_interface_WCLK = new EdifPort(RAM16X8S_replacement_interface, "WCLK", 1, 1);
				EdifPort RAM16X8S_replacement_interface_A0 = new EdifPort(RAM16X8S_replacement_interface, "A0", 1, 1);
				EdifPort RAM16X8S_replacement_interface_A1 = new EdifPort(RAM16X8S_replacement_interface, "A1", 1, 1);
				EdifPort RAM16X8S_replacement_interface_A2 = new EdifPort(RAM16X8S_replacement_interface, "A2", 1, 1);
				EdifPort RAM16X8S_replacement_interface_A3 = new EdifPort(RAM16X8S_replacement_interface, "A3", 1, 1);
				EdifPort RAM16X8S_replacement_interface_O = new EdifPort(RAM16X8S_replacement_interface, "O", 8, 2);
				RAM16X8S_replacement_interface.addPort("WE", 1, 1);
				RAM16X8S_replacement_interface.addPort("D", 8, 1);
				RAM16X8S_replacement_interface.addPort("WCLK", 1, 1);
				RAM16X8S_replacement_interface.addPort("A0", 1, 1);
				RAM16X8S_replacement_interface.addPort("A1", 1, 1);
				RAM16X8S_replacement_interface.addPort("A2", 1, 1);
				RAM16X8S_replacement_interface.addPort("A3", 1, 1);
				RAM16X8S_replacement_interface.addPort("O", 8, 2);
				//WE_ibuf
				...
				EdifPortRef RAM16X8S_replacement_WE = new EdifPortRef(we, RAM16X8S_replacement_interface_WE.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_D0 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_D1 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(1), null);
				EdifPortRef RAM16X8S_replacement_D2 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(2), null);
				EdifPortRef RAM16X8S_replacement_D3 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(3), null);
				EdifPortRef RAM16X8S_replacement_D4 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(4), null);
				EdifPortRef RAM16X8S_replacement_D5 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(5), null);
				EdifPortRef RAM16X8S_replacement_D6 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(6), null);
				EdifPortRef RAM16X8S_replacement_D7 = new EdifPortRef(d0, RAM16X8S_replacement_interface_D.getSingleBitPort(7), null);
				EdifPortRef RAM16X8S_replacement_WCLK = new EdifPortRef(wclk, RAM16X8S_replacement_interface_WCLK.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_A0 = new EdifPortRef(a0, RAM16X8S_replacement_interface_A0.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_A1 = new EdifPortRef(a1, RAM16X8S_replacement_interface_A1.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_A2 = new EdifPortRef(a2, RAM16X8S_replacement_interface_A2.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_A3 = new EdifPortRef(a3, RAM16X8S_replacement_interface_A3.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_O0 = new EdifPortRef(o0, RAM16X8S_replacement_interface_O.getSingleBitPort(0), null);
				EdifPortRef RAM16X8S_replacement_O1 = new EdifPortRef(o1, RAM16X8S_replacement_interface_O.getSingleBitPort(1), null);
				EdifPortRef RAM16X8S_replacement_O2 = new EdifPortRef(o2, RAM16X8S_replacement_interface_O.getSingleBitPort(2), null);
				EdifPortRef RAM16X8S_replacement_O3 = new EdifPortRef(o3, RAM16X8S_replacement_interface_O.getSingleBitPort(3), null);
				EdifPortRef RAM16X8S_replacement_O4 = new EdifPortRef(o4, RAM16X8S_replacement_interface_O.getSingleBitPort(4), null);
				EdifPortRef RAM16X8S_replacement_O5 = new EdifPortRef(o5, RAM16X8S_replacement_interface_O.getSingleBitPort(5), null);
				EdifPortRef RAM16X8S_replacement_O6 = new EdifPortRef(o6, RAM16X8S_replacement_interface_O.getSingleBitPort(6), null);
				EdifPortRef RAM16X8S_replacement_O7 = new EdifPortRef(o7, RAM16X8S_replacement_interface_O.getSingleBitPort(7), null);
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					else
					{
						...
						if(d==0)
							...
							LUT3_O[i] = new EdifPortRef(o4_c, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else if(d==5)
							LUT3_O[i] = new EdifPortRef(o5_c, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else if(d==6)
							LUT3_O[i] = new EdifPortRef(o6_c, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else
							LUT3_O[i] = new EdifPortRef(o7_c, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
					}
				}
				...
				//we
				we.addPortConnection(RAM16X8S_replacement_WE);
				...
				//d0
				d0.addPortConnection(RAM16X8S_replacement_D0);
				...
				//d1
				d1.addPortConnection(RAM16X8S_replacement_D1);
				...
				//d2
				d2.addPortConnection(RAM16X8S_replacement_D2);
				...
				//d3
				d3.addPortConnection(RAM16X8S_replacement_D3);
				...
				//d4
				d4.addPortConnection(RAM16X8S_replacement_D4);
				...
				//d5
				d5.addPortConnection(RAM16X8S_replacement_D5);
				...
				//d6
				d6.addPortConnection(RAM16X8S_replacement_D6);
				...
				//d7
				d7.addPortConnection(RAM16X8S_replacement_D7);
				...
				wclk.addPortConnection(RAM16X8S_replacement_WCLK);
				//wclk_c
				...
				//a0
				a0.addPortConnection(RAM16X8S_replacement_A0);
				...
				//a1
				a1.addPortConnection(RAM16X8S_replacement_A1);
				...
				//a2
				a2.addPortConnection(RAM16X8S_replacement_A2);
				...
				//a3
				a3.addPortConnection(RAM16X8S_replacement_A3);
	...
	public static void Replace(EdifLibraryManager libManager, EdifCell RAM16X8S_replacement,
			...
			EdifNet a0, EdifNet a1, EdifNet a2, EdifNet a3,
		...
		try{
			try{
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					else
					{
						...
						if(d==0)
							...
							LUT3_O[i] = new EdifPortRef(o4, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else if(d==5)
							LUT3_O[i] = new EdifPortRef(o5, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else if(d==6)
							LUT3_O[i] = new EdifPortRef(o6, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						else
							LUT3_O[i] = new EdifPortRef(o7, LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
					}
				}
				//Port reference of LUT4s
				EdifPortRef[] LUT4_I0 = new EdifPortRef[LUT4NUM];
				...
				//o4
				o4.addPortConnection(LUT3_O[44]);
				//o5
				o5.addPortConnection(LUT3_O[53]);
				//o6
				o6.addPortConnection(LUT3_O[62]);
				//o7
				o7.addPortConnection(LUT3_O[71]);
				//wires
				for(int i=0; i<FDENUM; i++)
				{
					int d = i/16;
