...
/**
 * Generates the EDIF file for RAM64X1S_1
 * Includes: 64 FDE_1s, 1 64-1 MUXs(39 LUT3s, 16 MUXF5s, and 8 MUXF6s for each), 1 6-64  decoder(14 LUT2s, 64 LUT4s).
 * 
 * @author Yubo Li
 *
 */

public class RAM64X1S_1_replacement{
	public static void main(String args[]){
		
		String outputFileName = "RAM64X1S_1_replacement.edf";
		
		try{
			/******Environment and Environment manager******/
			EdifEnvironment topLevel = new EdifEnvironment("RAM64X1S_1_replacement");
			...
			try{
				...
				EdifCell RAM64X1S_1_replacement = new EdifCell(work, "RAM64X1S_1_replacement");
				RAM64X1S_1_replacement.addPort("WE", 1, 1);
				RAM64X1S_1_replacement.addPort("D", 1, 1);
				RAM64X1S_1_replacement.addPort("WCLK", 1, 1);
				RAM64X1S_1_replacement.addPort("A0", 1, 1);
				RAM64X1S_1_replacement.addPort("A1", 1, 1);
				RAM64X1S_1_replacement.addPort("A2", 1, 1);
				RAM64X1S_1_replacement.addPort("A3", 1, 1);
				RAM64X1S_1_replacement.addPort("A4", 1, 1);
				RAM64X1S_1_replacement.addPort("A5", 1, 1);
				RAM64X1S_1_replacement.addPort("O", 1, 2);
				
				/******Design******/
				EdifDesign design = new EdifDesign("RAM64X1S_1_replacement");
				topLevel.setTopDesign(design);
				topLevel.setTopCell(RAM64X1S_1_replacement);
				...
				EdifNet wclk_c = new EdifNet("wclk_c", RAM64X1S_1_replacement);
				EdifNet wclk = new EdifNet("wclk", RAM64X1S_1_replacement);
				EdifNet d_c = new EdifNet("d_c", RAM64X1S_1_replacement);
				EdifNet d = new EdifNet("d", RAM64X1S_1_replacement);
				EdifNet we_c = new EdifNet("we_c", RAM64X1S_1_replacement);
				EdifNet we = new EdifNet("we", RAM64X1S_1_replacement);
				EdifNet a0_c = new EdifNet("a0_c", RAM64X1S_1_replacement);
				EdifNet a0 = new EdifNet("a0", RAM64X1S_1_replacement);
				EdifNet a1_c = new EdifNet("a1_c", RAM64X1S_1_replacement);
				EdifNet a1 = new EdifNet("a1", RAM64X1S_1_replacement);
				EdifNet a2_c = new EdifNet("a2_c", RAM64X1S_1_replacement);
				EdifNet a2 = new EdifNet("a2", RAM64X1S_1_replacement);
				EdifNet a3_c = new EdifNet("a3_c", RAM64X1S_1_replacement);
				EdifNet a3 = new EdifNet("a3", RAM64X1S_1_replacement);
				EdifNet a4_c = new EdifNet("a4_c", RAM64X1S_1_replacement);
				EdifNet a4 = new EdifNet("a4", RAM64X1S_1_replacement);
				EdifNet a5_c = new EdifNet("a5_c", RAM64X1S_1_replacement);
				EdifNet a5 = new EdifNet("a5", RAM64X1S_1_replacement);
				EdifNet o_c = new EdifNet("o_c", RAM64X1S_1_replacement);
				EdifNet o = new EdifNet("o", RAM64X1S_1_replacement);
				...
				for(int i=0; i<WIRENUM; i++)
				{
					...
					wire[i] = new EdifNet(wirename, RAM64X1S_1_replacement);
				}
				...
				for(int i=0; i<NETNUM; i++)
				{
					...
					net[i] = new EdifNet(netname, RAM64X1S_1_replacement);
				}
				...
				for(int i=0; i<ENUM; i++)
				{
					...
					e[i] = new EdifNet(ename, RAM64X1S_1_replacement);
				}
				//Add all nets to the top level design
				RAM64X1S_1_replacement.addNet(wclk_c);
				RAM64X1S_1_replacement.addNet(wclk);
				RAM64X1S_1_replacement.addNet(d_c);
				RAM64X1S_1_replacement.addNet(d);
				RAM64X1S_1_replacement.addNet(we_c);
				RAM64X1S_1_replacement.addNet(we);
				RAM64X1S_1_replacement.addNet(a0_c);
				RAM64X1S_1_replacement.addNet(a0);
				RAM64X1S_1_replacement.addNet(a1_c);
				RAM64X1S_1_replacement.addNet(a1);
				RAM64X1S_1_replacement.addNet(a2_c);
				RAM64X1S_1_replacement.addNet(a2);
				RAM64X1S_1_replacement.addNet(a3_c);
				RAM64X1S_1_replacement.addNet(a3);
				RAM64X1S_1_replacement.addNet(a4_c);
				RAM64X1S_1_replacement.addNet(a4);
				RAM64X1S_1_replacement.addNet(a5_c);
				RAM64X1S_1_replacement.addNet(a5);
				RAM64X1S_1_replacement.addNet(o_c);
				RAM64X1S_1_replacement.addNet(o);
				for(int i=0; i<WIRENUM; i++)
				{
					RAM64X1S_1_replacement.addNet(wire[i]);
				}
				for(int i=0; i<NETNUM; i++)
				{
					RAM64X1S_1_replacement.addNet(net[i]);
				}
				for(int i=0; i<ENUM; i++)
				{
					RAM64X1S_1_replacement.addNet(e[i]);
				}
				...
				EdifCellInstance WE_ibuf = new EdifCellInstance("WE_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance D_ibuf = new EdifCellInstance("D_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance WCLK_ibuf = new EdifCellInstance("WCLK_ibuf", RAM64X1S_1_replacement, BUFGP);
				EdifCellInstance A0_ibuf = new EdifCellInstance("A0_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance A1_ibuf = new EdifCellInstance("A1_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance A2_ibuf = new EdifCellInstance("A2_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance A3_ibuf = new EdifCellInstance("A3_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance A4_ibuf = new EdifCellInstance("A4_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance A5_ibuf = new EdifCellInstance("A5_ibuf", RAM64X1S_1_replacement, IBUF);
				EdifCellInstance O_obuf = new EdifCellInstance("O_obuf", RAM64X1S_1_replacement, OBUF);
				//FDE_1s
				...
				for(int i=0; i<FDE_1NUM; i++)
				{
					...
					FDE_1_[i] = new EdifCellInstance(fdename, RAM64X1S_1_replacement, FDE_1);
				}
				//LUT2s
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_[i] = new EdifCellInstance(lut2name, RAM64X1S_1_replacement, LUT2);
				}
				//LUT3s
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					LUT3_[i] = new EdifCellInstance(lut3name, RAM64X1S_1_replacement, LUT3);
				}
				//LUT4s
				...
				for(int i=0; i<LUT4NUM; i++)
				{
					...
					LUT4_[i] = new EdifCellInstance(lut4name, RAM64X1S_1_replacement, LUT4);
				}
				//MUXF5
				...
				for(int i=0; i<MUXF5NUM; i++)
				{
					...
					MUXF5_[i] = new EdifCellInstance(muxf5name, RAM64X1S_1_replacement, MUXF5);
				}
				//MUXF6
				...
				for(int i=0; i<MUXF6NUM; i++)
				{
					...
					MUXF6_[i] = new EdifCellInstance(muxf6name, RAM64X1S_1_replacement, MUXF6);
				}
				//Add all instances to the top level design
				RAM64X1S_1_replacement.addSubCell(WE_ibuf);
				RAM64X1S_1_replacement.addSubCell(D_ibuf);
				RAM64X1S_1_replacement.addSubCell(WCLK_ibuf);
				RAM64X1S_1_replacement.addSubCell(A0_ibuf);
				RAM64X1S_1_replacement.addSubCell(A1_ibuf);
				RAM64X1S_1_replacement.addSubCell(A2_ibuf);
				RAM64X1S_1_replacement.addSubCell(A3_ibuf);
				RAM64X1S_1_replacement.addSubCell(A4_ibuf);
				RAM64X1S_1_replacement.addSubCell(A5_ibuf);
				RAM64X1S_1_replacement.addSubCell(O_obuf);
				for(int i=0; i<FDE_1NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(FDE_1_[i]);
				}
				for(int i=0; i<LUT2NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(LUT2_[i]);
				}
				for(int i=0; i<LUT3NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(LUT3_[i]);
				}
				for(int i=0; i<LUT4NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(LUT4_[i]);
				}
				for(int i=0; i<MUXF5NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(MUXF5_[i]);
				}
				for(int i=0; i<MUXF6NUM; i++)
				{
					RAM64X1S_1_replacement.addSubCell(MUXF6_[i]);
				}
				
				/******Interface******/
				//Interface of buffers
				EdifCellInterface RAM64X1S_1_replacement_interface = new EdifCellInterface(RAM64X1S_1_replacement);
				...
				/******Ports******/
				//RAM64X1S_1_replacement
				EdifPort RAM64X1S_1_replacement_interface_WE = new EdifPort(RAM64X1S_1_replacement_interface, "WE", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_D = new EdifPort(RAM64X1S_1_replacement_interface, "D", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_WCLK = new EdifPort(RAM64X1S_1_replacement_interface, "WCLK", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A0 = new EdifPort(RAM64X1S_1_replacement_interface, "A0", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A1 = new EdifPort(RAM64X1S_1_replacement_interface, "A1", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A2 = new EdifPort(RAM64X1S_1_replacement_interface, "A2", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A3 = new EdifPort(RAM64X1S_1_replacement_interface, "A3", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A4 = new EdifPort(RAM64X1S_1_replacement_interface, "A4", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_A5 = new EdifPort(RAM64X1S_1_replacement_interface, "A5", 1, 1);
				EdifPort RAM64X1S_1_replacement_interface_O = new EdifPort(RAM64X1S_1_replacement_interface, "O", 1, 2);
				RAM64X1S_1_replacement_interface.addPort("WE", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("D", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("WCLK", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A0", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A1", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A2", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A3", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A4", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("A5", 1, 1);
				RAM64X1S_1_replacement_interface.addPort("O", 1, 2);
				//WE_ibuf
				...
				EdifPortRef RAM64X1S_1_replacement_WE = new EdifPortRef(we, RAM64X1S_1_replacement_interface_WE.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_D = new EdifPortRef(d, RAM64X1S_1_replacement_interface_D.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_WCLK = new EdifPortRef(wclk, RAM64X1S_1_replacement_interface_WCLK.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A0 = new EdifPortRef(a0, RAM64X1S_1_replacement_interface_A0.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A1 = new EdifPortRef(a1, RAM64X1S_1_replacement_interface_A1.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A2 = new EdifPortRef(a2, RAM64X1S_1_replacement_interface_A2.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A3 = new EdifPortRef(a3, RAM64X1S_1_replacement_interface_A3.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A4 = new EdifPortRef(a4, RAM64X1S_1_replacement_interface_A4.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_A5 = new EdifPortRef(a5, RAM64X1S_1_replacement_interface_A5.getSingleBitPort(0), null);
				EdifPortRef RAM64X1S_1_replacement_O = new EdifPortRef(o, RAM64X1S_1_replacement_interface_O.getSingleBitPort(0), null);
				...
				//we
				we.addPortConnection(RAM64X1S_1_replacement_WE);
				...
				//d
				d.addPortConnection(RAM64X1S_1_replacement_D);
				...
				wclk.addPortConnection(RAM64X1S_1_replacement_WCLK);
				//wclk_c
				...
				//a0
				a0.addPortConnection(RAM64X1S_1_replacement_A0);
				...
				//a1
				a1.addPortConnection(RAM64X1S_1_replacement_A1);
				...
				//a2
				a2.addPortConnection(RAM64X1S_1_replacement_A2);
				...
				//a3
				a3.addPortConnection(RAM64X1S_1_replacement_A3);
				...
				//a4
				a4.addPortConnection(RAM64X1S_1_replacement_A4);
				...
				//a5
				a5.addPortConnection(RAM64X1S_1_replacement_A5);
				...
				o.addPortConnection(RAM64X1S_1_replacement_O);
				//o_c
				o_c.addPortConnection(O_obuf_I);
				o_c.addPortConnection(LUT3_O[38]);
				//wires
				for(int i=0; i<WIRENUM; i++)
				{
					int lutNumber = 0;
	...
	public static void Replace(EdifLibraryManager libManager, EdifCell RAM64X1S_1_replacement, long INIT,
			EdifNet we, EdifNet d, EdifNet wclk, EdifNet a0, EdifNet a1, EdifNet a2, EdifNet a3, EdifNet a4, EdifNet a5, EdifNet o) {
		try{
			try{
				/******Cells******/
