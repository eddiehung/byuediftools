...
public class jhdlmultisrltest extends Logic {
    ...
    public jhdlmultisrltest(Node parent,
                            Wire datain,
                            Wire ce,
                            Wire clk,
                            Wire a,
        ...
        new srlc16(this, clk, datain, a, srlc16.gw(0), 
                   srlc16.gw(1), init); 
        new srlc16(this, clk, datain, a, srlc16.gw(2), 
                   srlc16.gw(3), init); 
        new srlc16(this, clk, datain, a, srlc16.gw(4), 
                   srlc16.gw(5), init); 

        new srlc16_1(this, clk, datain, a, srlc161.gw(0), 
                     srlc161.gw(1), init); 
        new srlc16_1(this, clk, datain, a, srlc161.gw(2), 
                     srlc161.gw(3), init); 
        new srlc16_1(this, clk, datain, a, srlc161.gw(4), 
                     srlc161.gw(5), init); 

        new srlc16e(this, clk, datain, ce, a, srlc16e.gw(0), 
                    srlc16e.gw(1), init); 
        new srlc16e(this, clk, datain, ce, a, srlc16e.gw(2), 
                    srlc16e.gw(3), init); 
        new srlc16e(this, clk, datain, ce, a, srlc16e.gw(4), 
                    srlc16e.gw(5), init); 

        new srlc16e_1(this, clk, datain, ce, a, srlc16e1.gw(0), 
                      srlc16e1.gw(1), init); 
        new srlc16e_1(this, clk, datain, ce, a, srlc16e1.gw(2), 
                      srlc16e1.gw(3), init); 
        new srlc16e_1(this, clk, datain, ce, a, srlc16e1.gw(4), 
                      srlc16e1.gw(5), init); 
