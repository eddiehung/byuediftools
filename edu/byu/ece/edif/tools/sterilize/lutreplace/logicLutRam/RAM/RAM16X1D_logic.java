/*
 * Logic implementation of a RAM16X1D.
 * 
...
public class RAM16X1D_logic extends Logic {
    ...
    public RAM16X1D_logic(Node parent, Wire we, Wire d, Wire wclk, Wire a0, Wire a1, Wire a2, Wire a3, Wire dpra0,
