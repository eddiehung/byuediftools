/*
 * Logic implementation of a RAM32X8S
 * 
...
public class RAM32X8S_logic extends Logic {
    public static CellInterface cell_interface[] = { in("WE", 1), in("D", 8), in("WCLK", 1), in("A0", 1), in("A1", 1),
            in("A2", 1), in("A3", 1), in("A4", 1), out("O", 8), };

    protected boolean cellInterfaceDeterminesUniqueNetlistStructure() {
        return true;
    }

    public RAM32X8S_logic(Node parent, Wire we, Wire d, Wire wclk, Wire a0, Wire a1, Wire a2, Wire a3, Wire a4, Wire o,
