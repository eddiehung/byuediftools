...
public class jhdlsimpletests extends Logic {
    ...
    public jhdlsimpletests(Node parent,
                           Wire indata,
                           Wire we,
                           Wire clk,
                           Wire ra,
        ...
        new RAM128X1S_1_logic(this, we, indata.gw(0), clk, ra.gw(0), ra.gw(1), ra.gw(2), ra.gw(3), 
                            ra.gw(4), ra.gw(5), ra.gw(6), r16x1dlogic.gw(0), 
                            init32[0], init32[1], init32[2], init32[3]);
        
        new ram128x1s_1(this, indata.gw(0), we, ra.range(6, 0), r16x1djhdl.gw(0), clk, 
                        sinit32[3]+sinit32[2]+sinit32[1]+sinit32[0]);
