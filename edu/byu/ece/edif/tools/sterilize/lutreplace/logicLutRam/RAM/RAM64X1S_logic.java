/*
 * Logic implementation of a RAM64X1S
 * 
...
public class RAM64X1S_logic extends Logic {
    ...
    public RAM64X1S_logic(Node parent, Wire we, Wire d, Wire wclk, Wire a0, Wire a1, Wire a2, Wire a3, Wire a4,
