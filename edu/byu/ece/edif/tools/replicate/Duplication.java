...
public class Duplication extends AbstractReplication {
    public static final long serialVersionUID = 42L;

    public Duplication(Object toBeReplicated) throws ReplicationException {
        super(toBeReplicated);
        _replicationFactor = 2;
        _replicationType = ReplicationType.DUPLICATE;
    }
    ...
    public Duplication toStringReference() throws ReplicationException {
        if (!(_toBeReplicated instanceof EdifNameableStringReference))
            return new Duplication(new EdifNameableStringReference((NamedPropertyObject) _toBeReplicated));
        else
