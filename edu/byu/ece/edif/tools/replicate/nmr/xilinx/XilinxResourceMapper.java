...
public class XilinxResourceMapper implements ResourceMapper {
    ...
    static {
        ...
        //one lut holds 16 bits of single port data
        //two luts hold 16 bits of dual port data
        cellToLUTEquivalentMap.put("RAM128X1S", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM128X1S_1", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM16X1D", new Double(2.0));
        cellToLUTEquivalentMap.put("RAM16X1D_1", new Double(2.0));
        cellToLUTEquivalentMap.put("RAM16X1S", new Double(1.0));
        cellToLUTEquivalentMap.put("RAM16X1S_1", new Double(1.0));
        cellToLUTEquivalentMap.put("RAM16X2S", new Double(2.0));
        cellToLUTEquivalentMap.put("RAM16X4S", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM16X8S", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM32X1D", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM32X1D_1", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM32X1S", new Double(2.0));
        cellToLUTEquivalentMap.put("RAM32X1S_1", new Double(2.0));
        cellToLUTEquivalentMap.put("RAM32X2S", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM32X4S", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM32X8S", new Double(16.0));
        cellToLUTEquivalentMap.put("RAM64X1D", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM64X1D_1", new Double(8.0));
        cellToLUTEquivalentMap.put("RAM64X1S", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM64X1S_1", new Double(4.0));
        cellToLUTEquivalentMap.put("RAM64X2S", new Double(8.0));
        cellToLUTEquivalentMap.put("ROM128X1", new Double(8.0));
        cellToLUTEquivalentMap.put("ROM16X1", new Double(1.0));
        cellToLUTEquivalentMap.put("ROM256X1", new Double(16.0));
        cellToLUTEquivalentMap.put("ROM32X1", new Double(2.0));
        cellToLUTEquivalentMap.put("ROM64X1", new Double(4.0));
