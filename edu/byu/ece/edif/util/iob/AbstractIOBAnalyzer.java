...
public abstract class AbstractIOBAnalyzer {
	...
	/**
	 * @return A Collection of EdifCellInstances corresponding to all of the
	 *   IOB instances in this EdifCell
	 */
	public Collection<EdifCellInstance> getAllIOBInstances() {
		...
		for (AbstractIOB xiob : _iobMap.values()) {
			...
			if (xiob != null) ecis.addAll(xiob.getAllInstances());
		}
	...
	/**
	 * @return A Collection of EdifCellInstances corresponding to all of the
	 *   IOB registers in this EdifCell
	 */
	public Collection<EdifCellInstance> getAllIOBRegisters() {
		...
		for (AbstractIOB xiob : _iobMap.values()) {
			// Get input, output, and tristate regs in each IOB
			if (xiob != null) iobRegs.addAll(xiob.getRegs());
		}
	 ...
	 * graph.
	 * 
	 * The decision of which EPR is not smart currently. Please use 
	...
	public Collection<EdifPortRef> getIOBFeedbackEPRs() {
		...
		//   case in which a top-level port directly drives another 
		//   top-level port).
	...
	/**
	 * @return A Collection of EdifCellInstances corresponding to all of the
	 *   IOB instances associated with this EdifSingleBitPort
	 */
	...
	/**
	 * @return A Collection of EdifCellInstances corresponding to all of the
	 *   IOB instances associated with these EdifSingleBitPorts
	 */
	...
	/**
	 * @return A Collection of EdifCellInstances corresponding to all of the
	 *   IOB registers in associated with this EdifSingleBitPort (including
	 *   input register, output register, and tristate register)
	 */
