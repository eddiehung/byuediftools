...
/**
 * This class is used represent the command line options for specifying 
 * an output file.
 ...
 *   a filename from the parsed extension (i.e. allow a default output
 *   filename based on the input filename: input.edf -> input.jedif)
 **/
