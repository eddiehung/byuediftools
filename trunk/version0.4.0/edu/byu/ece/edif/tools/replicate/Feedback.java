...
public class Feedback extends AbstractReplication {
    public static final long serialVersionUID = 42L;

    public Feedback(Object toBeReplicated) throws ReplicationException {
        super(toBeReplicated);
        _replicationType = ReplicationType.FEEDBACK;
    }

    public Feedback toStringReference() throws ReplicationException {
        if (!(_toBeReplicated instanceof EdifNameableStringReference))
            return new Feedback(new EdifNameableStringReference((NamedPropertyObject) _toBeReplicated));
        else
