/*
 * Instances a logic and a JHDL RAMX1D. Used for testing purposes.
 * 
...
import byucc.jhdl.Xilinx.Virtex2.ram16x1d;
...
public class jhdlsimpletest extends Logic {
    public static CellInterface cell_interface[] = { in("indata", 8), in("we", 1), in("clk", 1), in("wa", 7),
            in("ra", 7), out("o16x1dlogic", 2), out("o16x1djhdl", 2),

    };

    public jhdlsimpletest(Node parent, Wire indata, Wire we, Wire clk, Wire wa, Wire ra, Wire o16x1dlogic,
            Wire o16x1djhdl) {
        ...
        new RAM16X1D_logic(this, we, indata.gw(0), clk, wa.gw(0), wa.gw(1), wa.gw(2), wa.gw(3), ra.gw(0), ra.gw(1), ra
                .gw(2), ra.gw(3), r16x1dlogic.gw(0), r16x1dlogic.gw(1), init16[0]);

        new ram16x1d(this, indata.gw(0), we, wa.range(3, 0), ra.range(3, 0), r16x1djhdl.gw(0), r16x1djhdl.gw(1), clk,
                sinit16[0]);
