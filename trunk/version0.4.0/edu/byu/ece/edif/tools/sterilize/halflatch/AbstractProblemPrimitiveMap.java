...
public abstract class AbstractProblemPrimitiveMap implements ProblemPrimitiveMap {
    ...
    /**
     * Maps primitive names to the will-be floating port names once it is
     * replaced by its corresponding 'safe primitive'
     */
    protected Map<String, int[]> _floatingPortDefaultValueMap;

    /**
     * Maps primitive names to the will-be floating port default values (once it
     * is replaced by its corresponding 'safe primitive')
     */
