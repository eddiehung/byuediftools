/*
 * Testbench to compare a single logic RAMX1D with a Xilinx RAMX1D primitive.
 * 
...
public class tb_jhdlsimple extends Logic implements TestBench {
    ...
    public tb_jhdlsimple(Node parent) {
        ...
        clockDriver(clk, "01");
        jhdlsimpletest logicram = new jhdlsimpletest(this, indata, we, clk, wa, ra, o16x1dlogic, o16x1djhdl);
    }
