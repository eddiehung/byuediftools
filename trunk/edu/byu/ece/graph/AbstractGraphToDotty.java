...
public class AbstractGraphToDotty {
	...
	public void addNodeLabel(StringBuffer sb, Object node, String color, String shape) {
		sb.append("[label=\""+node2Dotty(node));
		sb.append("\" "+nodeProperties(node, color, shape)+"];\n");
	}
    ...
    public String node2Dotty(Object node) {
		...
		if (node instanceof EdifCellInstance) {
			...
			sb.append("["+convertSpecialsToEscapes(((NamedPropertyObject)node).getName().trim())+"]");
    ...
    public enum Color {
    	...
    	blanchedalmond, floralwhite, lavender, linen, mintcream, moccasin,  
    	oldlace, papayawhip, white, whitesmoke,
    	...
    	dimgray, gray, lightgray, lightslategray,
    	...
    	inianred1, inianred2, inianred3, inianred4,
    	...
    	crimson, darksalmon, mediumvioletred,
    	...
    	tan1, tan2, tan3, tan4,
    	beige, darkkhaki, peru, saddlebrown, sandybrown,
    	...
    	greenyellow, lightgoldenrodyellow, palegoldenrod, yellowgreen,
    	
    	/*
    	 * greens
    	 */
    	chartruse1, chartruse2, chartruse3, chartruse4,
    	...
    	darkgreen, forestgreen, /*greenyellow, */ lawngreen, lightseagreen,
    	limegreen, mediumseagreen, mediumspringgreen, /* mintcream, yellowgreen,*/
    	...
    	darkturquoise, mediumaquamarine, mediumturquoise,
    	...
    	aliceblue, blueviolet, cornflowerblue, darkslateblue, indigo,
    	mediumblue, mediumslateblue, midnightblue, navy, navyblue, powerblue,
     ...
     */
    public enum Shape {
    	box, polygon, ellipse, circle, point, egg, triangle, plaintext,
