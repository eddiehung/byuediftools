...
public abstract class AbstractGraph implements DirectedGraph {
	 ...
	 *         successors of the node passed in as a parameter. The Collection
	 *         should be empty if there are no successors.
	 */
	...
	/**
	 * @return a Collection of node objects in the graph that are direct
	 *         predecessors of the node passed in as a parameter. The Collection
	 *         should be empty if there are no predecessors.
	 */
	public Collection getPredecessors(Object node) {
		Collection predecessors = new ArrayList();
		
		// To get the predecessor nodes:
		//    get the links in which this node is the sink
		//    get the source nodes of the links
	 ...
	 *         the node passed in as a parameter. Ancestors are all nodes that
	 *         can reach the node. The Collection should be empty if there are
	 *         no ancestors.
	 */
	...
	/**
	 * @return a Collection of node objects in the graph that are ancestors of
	 *         each of the nodes passed in as a parameter. Ancestors are all
	 *         nodes that can reach any of the nodes in the Collection. The
	 *         Collection should be empty if there are no ancestors.
	 * 
	...
	/**
	 * @return a Collection of node objects in the graph that are descendents of
	 *         the node passed in as a parameter. Descendents are all nodes that
	 *         are reachable from the node. The Collection should be empty if
	...
	/**
	 * @return a Collection of node objects in the graph that are descendents of
	 *         any of the Nodes in the Collection passed in as a parameter.
	 *         Descendents are all nodes that are reachable from any node in the
	 *         Collection. The Collection should be empty if there are no
	 *         descendents.
	 * 
	 * Note: this method is not part of the DirectedGraph interface.
	 */
	 ...
	 * descendents.
	 * 
	 * The algorithm for finding ancestors and descendents is the same and this
	 ...
	 * @return
	 */
	protected List _getAncestorsOrDescendents(Collection nodes,
	...
	/**
	 * Provides the ancestors or descendents of a single Node.
	 */
	protected List _getAncestorsOrDescendents(Object node, 
			boolean predecessors) {
