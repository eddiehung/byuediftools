 ...
 * An edge object contains a source object and a sink object.
 * The actual implementation of this interface can return an
 * object of any type.
 * 
 * @author Brian Pratt
 */
public interface Edge extends Serializable {
	...
	/**
	 * Return a new edge object that is the inverse of
	 * this object. The resulting Edge will swap
	 * the source and sink objects.
	 * 
	 * @return sink object.
	 */
	public Edge invert();
