 ...
 * based on {@link JSAP} (Java-based Simple Argument Parser).
 */
...
public class NMRCommandParser extends JSAPCommandParser {
	...
	public NMRCommandParser(int replicationFactor) {
		...
		_NMRParameters
				.add(new FlaggedOption(OUTPUT_FILE)
						...
						.setHelp(
								"Filename and path to the triplicated EDIF output file created by the BLTmr tool."));

		_NMRParameters
				.add(new FlaggedOption(DIR)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag('d')
						.setLongFlag("dir")
		...
		_NMRParameters
				.add(new FlaggedOption(NMR_SUFFIX)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("nmrSuffix")
						.setAllowMultipleDeclarations(JSAP.NO_MULTIPLEDECLARATIONS)
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("suffix")
						.setHelp(
								"Comma-separated list of the "+replicationFactor+" suffixes to use when replicating components."));

		/*
		 * Partial NMR options
		 */
		_NMRParameters
				.add(new Switch(FULL_NMR)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("full_nmr")
						.setDefault(FALSE)
						.setHelp(
								"Fully triplicate the design, skipping all partial NMR analysis."));

		_NMRParameters.add(new Switch(NMR_INPORTS).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("nmr_inports").setDefault(FALSE)
				.setHelp("Triplicate top-level input ports."));

		_NMRParameters.add(new Switch(NMR_OUTPORTS).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("nmr_outports")
				.setDefault(FALSE)
				.setHelp("Triplicate top-level output ports."));
		...
		_NMRParameters
				.add(new FlaggedOption(NMR_C)
						...
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("cell_type")
						.setHelp(
								"Comma-separated list of cell types to be triplicated."));
		
		_NMRParameters
						.add(new FlaggedOption(NMR_CLK)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("nmr_clk")
		...
		_NMRParameters
				.add(new FlaggedOption(NMR_I)
						...
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("cell_instance")
						.setHelp(
								"Comma-separated list of cell instances to be triplicated."));

		_NMRParameters
				.add(new FlaggedOption(NO_NMR_C)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("no_nmr_c")
						.setAllowMultipleDeclarations(JSAP.MULTIPLEDECLARATIONS)
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("cell_type")
		...
		_NMRParameters
						.add(new FlaggedOption(NO_NMR_CLK)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("no_nmr_clk")
						.setAllowMultipleDeclarations(JSAP.MULTIPLEDECLARATIONS)
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("clock_domain")
		...
		_NMRParameters
				.add(new FlaggedOption(NO_NMR_I)
						.setStringParser(JSAP.STRING_PARSER)
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("no_nmr_i")
						.setAllowMultipleDeclarations(JSAP.MULTIPLEDECLARATIONS)
						.setList(JSAP.LIST)
						.setListSeparator(LIST_DELIMITER)
						.setUsageName("cell_instance")
		...
		_NMRParameters
				.add(new Switch(NO_NMR_FEEDBACK)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("no_nmr_feedback")
						.setDefault(FALSE)
						.setHelp(
		...
		_NMRParameters.add(new Switch(DO_SCC_DECOMPOSITION).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("doSCCDecomposition")
				.setDefault(FALSE).setHelp(
						"Allow SCCs to be partially triplicated."));
		
		
		_NMRParameters.add(new Switch(USE_BAD_CUT_CONN).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("use_bad_cut_conn")
				.setDefault(FALSE).setHelp(
						"Use bad cut connections option."));
		
		
		_NMRParameters.add(new Switch(HIGHEST_FANOUT_CUTSET).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("highest_fanout_cutset")
				.setDefault(FALSE).setHelp(
						"Use highest fanout cutset option."));
		
		_NMRParameters.add(new Switch(HIGHEST_FF_FANOUT_CUTSET).setShortFlag(
				JSAP.NO_SHORTFLAG).setLongFlag("highest_ff_fanout_cutset")
				.setDefault(FALSE).setHelp(
						"Use highest flip-flop cutset option"));
		 ...
		 */
		_NMRParameters
				.add(new FlaggedOption(MERGE_FACTOR)
						.setStringParser(_zeroToOneInclusive)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("mergeFactor")
						.setDefault("0.5")
						.setHelp(
		...
		_NMRParameters
				.add(new FlaggedOption(FACTOR_TYPE)
						.setStringParser(
								EnumeratedStringParser.getParser(FACTOR_TYPES,
										false))
						.setRequired(JSAP.NOT_REQUIRED)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag(FACTOR_TYPE)
						.setDefault(
								NMRUtilities.DEFAULT_UTILIZATION_FACTOR
										.toString())
						.setUsageName(
								"{" + FACTOR_TYPES.replace(';', '|') + "}")
						.setHelp(
								"Utilization Factor type. Must be one of the following: "
										+ FACTOR_TYPES.replace(";", ", ")
		 ...
		 */
		_NMRParameters
				.add(new FlaggedOption(LOW)
						.setStringParser(_minZeroInclusive)
						.setRequired(JSAP.NOT_REQUIRED)
						.setLongFlag(LOW)
						.setHelp(
								"Utilization factor lower bound for multiple EDIF file creation."));

		_NMRParameters
				.add(new FlaggedOption(HIGH)
						.setStringParser(_minZeroInclusive)
						.setRequired(JSAP.NOT_REQUIRED)
						.setLongFlag(HIGH)
						.setHelp(
								"Utilization factor upper bound for multiple EDIF file creation."));

		_NMRParameters
				.add(new FlaggedOption(INC)
						.setStringParser(_zeroToOneInclusive)
						.setRequired(JSAP.NOT_REQUIRED)
						.setLongFlag(INC)
						.setDefault("0.10")
		...
		_NMRParameters
				.add(new FlaggedOption(HL_CONSTANT)
						.setStringParser(_zeroOne)
						.setShortFlag(JSAP.NO_SHORTFLAG)
						.setLongFlag("hlConst")
						.setDefault("0")
						.setUsageName("{0|1}")
	...
	public static void main(String[] args) {
		...
		LinkedHashSet<Parameter> allParameters = new LinkedHashSet<Parameter>(
				_NMRParameters);
	...
	public JSAPResult parse(String[] args) {
		...
		if (_result.getBoolean(HELP)) {
			...
			System.out.println();
			System.out.println("For more detailed information, see "
					+ _MORE_INFO + ".");
			System.out.println();
			 ...
			 * configuration files.
			 */
			this.registerDefaultSource(new PropertyDefaultSource(_result
					.getString(USE_CONFIG), false));
			System.out.println("Using config file: "+_result.getString(USE_CONFIG));
		}

		// Register the default configuration files.
		this.registerDefaultSource(new PropertyDefaultSource(CONF_FILENAME,
				false));
		this.registerDefaultSource(new PropertyDefaultSource(ETC_FILENAME,
				false));
		...
		if (!validateUtlizationFactorValues())
			_result.addException(null, new JSAPException(
					"Failed to validate utilization factors."));
		...
		if (!_result.success()) {
			...
			for (java.util.Iterator errs = _result.getErrorMessageIterator(); errs
					.hasNext();) {
	 ...
	 * 
	 * Note that one parameter should not be specified without the other; this
	 * is ensured by the {@link NMRCommandParser} when the command-line
	...
	protected boolean validateMultipleEDIF() {
		...
		if (_result.contains(LOW) ^ _result.contains(HIGH)) {
			_result.addException(null,
					new JSAPException("In attempting to activate multiple EDIF " +
							"creation, only one bound detected.  To use " +
							"multiple EDIF creation, both a low and " +
	...
	/**
	 * Parse the NMR suffixes to ensure they are valid. The rules are:
	...
	protected boolean validateNMRSuffixes() {
		...
		if (suffixes.length != replicationFactor) {
			_result.addException(null,
					new JSAPException("Invalid suffix list. " +
							"The suffix array must have "+
		...
		if (!NMREdifCell.areReplicationSuffixesUnique(suffixes, replicationFactor)) {
			_result.addException(null,
					new JSAPException("Invalid replicationSuffix list. " +
	...
	protected boolean validateUtlizationFactorValues() {
		...
		if (!validateMultipleEDIF()) {
			_result.addException(null, new JSAPException(
					"Failed to validate Multiple EDIF Creation."));
			return false;
		}
		...
		for (String parameter : parametersToValidate) {
			try {
				_minZeroInclusive.parse(Double.toString(_result
						.getDouble(parameter)));
	 ...
	 * 
	 * Use for all of the {@linkplain UtilizationFactor utilization factors}:
	 * ASUF, UEF, and DUF.
	 */
	 ...
	 * Set := {1,2,3}
	 * 
	 * Use for {@linkplain #INPUT_ADDITION_TYPE inputAdditionType},
	 ...
	 * Range := [0,1]
	 * 
	 * Use for {@linkplain #MERGE_FACTOR mergeFactor},
	 ...
	 * Set := {0,1}
	 * 
	 * Use for {@linkplain #HL_CONSTANT hlConst}.
	 */
