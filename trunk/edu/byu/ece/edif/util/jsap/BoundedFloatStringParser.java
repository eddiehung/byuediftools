/*
 * A StringParser for parsing Floats with optional minimum and maximum values.
 * 
...
class BoundedFloatStringParser extends FloatStringParser {
     ...
     */
    @Deprecated
    public BoundedFloatStringParser(Float min, Float max, Boolean includeMin, Boolean includeMax)
     ...
     * @throws IllegalArgumentException if min is greater than max.
     */
    public static BoundedFloatStringParser getParser(Float min, Float max, Boolean includeMin, Boolean includeMax)
            throws IllegalArgumentException {
