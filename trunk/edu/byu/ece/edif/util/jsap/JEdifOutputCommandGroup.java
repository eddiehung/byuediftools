...
public class JEdifOutputCommandGroup extends OutputFileCommandGroup {
	/**
	 * This class is used output JEdifFiles. It can optionally prune unused
	 * cells and defaults to .jedif if no extension is specified.
	 * 
	...
	public JEdifOutputCommandGroup() {
		...
		_deleteOldCells.setHelp(
				"don't delete old cells from the edif environment");
