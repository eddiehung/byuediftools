...
public class TechnologyCommandGroup extends AbstractCommandGroup {
	 ...
	 * Make sure to call getPartFromEDIF() after the commandline
	 * has been parsed.
	 *
	 */
	public TechnologyCommandGroup() {
		...
		_part.setHelp("Target architecture for the triplicated design. " +
	...
	/**
	 * Scans the Edif Environment for the PART string. if it exists and is valid,
	 * the default is assigned. Otherwise throw an exception. If you do not require
	 * the part to be set, then you can catch and ignore the exception.
	 * 
	 * After calling this function, getPart(), getTech(), and getArch() can be called
	 * normally.
	 * 
	 * @param result
	 * @param env
	 ...
	 */
	public static void getPartFromEDIF(JSAPResult result, EdifEnvironment env) 
		throws IllegalArgumentException{
