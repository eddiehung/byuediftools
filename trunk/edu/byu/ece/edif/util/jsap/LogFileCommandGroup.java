...
/**
 * Parses options for a Logfile, and provides several levels of output so 
 * the user can choose what level of output to see
 *  
...
public class LogFileCommandGroup extends AbstractCommandGroup {
	...
	public LogFileCommandGroup(String logfile){
		...
		_append_log_file.setHelp("Use this switch to append to " +
				"the log file, instead of replacing it");
	...
	public static long reportTime(long startTime, String description,PrintStream out) {
		...
		out.println("TIMESTAMP: " + description + " took " + 
				NMRUtilities.msToString(elapsedTime));
	...
	protected static BoundedIntegerStringParser _oneFive = BoundedIntegerStringParser
	.getParser(1, 5);
}
