...
/**
 * Generates the EDIF file for RAM16X4D
 * Includes: 64 FDEs, 8 16-1 MUXs(9 LUT3s, 4 MUXF5s, and 2 MUXF6s for each), 1 4-16 decoder(2 LUT2s, 16 LUT4s).
 * 
 * @author Yubo Li
 *
 */

public class RAM16X4D_replacement{
	public static void main(String args[]){
		
		String outputFileName = "RAM16X4D_replacement.edf";
		
		try{
			/******Environment and Environment manager******/
			EdifEnvironment topLevel = new EdifEnvironment("RAM16X4D_replacement");
			...
			try{
				...
				EdifCell RAM16X4D_replacement = new EdifCell(work, "RAM16X4D_replacement");
				RAM16X4D_replacement.addPort("WE", 1, 1);
				RAM16X4D_replacement.addPort("D0", 1, 1);
				RAM16X4D_replacement.addPort("D1", 1, 1);
				RAM16X4D_replacement.addPort("D2", 1, 1);
				RAM16X4D_replacement.addPort("D3", 1, 1);
				RAM16X4D_replacement.addPort("WCLK", 1, 1);
				RAM16X4D_replacement.addPort("A0", 1, 1);
				RAM16X4D_replacement.addPort("A1", 1, 1);
				RAM16X4D_replacement.addPort("A2", 1, 1);
				RAM16X4D_replacement.addPort("A3", 1, 1);
				RAM16X4D_replacement.addPort("DPRA0", 1, 1);
				RAM16X4D_replacement.addPort("DPRA1", 1, 1);
				RAM16X4D_replacement.addPort("DPRA2", 1, 1);
				RAM16X4D_replacement.addPort("DPRA3", 1, 1);
				RAM16X4D_replacement.addPort("SPO0", 1, 2);
				RAM16X4D_replacement.addPort("SPO1", 1, 2);
				RAM16X4D_replacement.addPort("SPO2", 1, 2);
				RAM16X4D_replacement.addPort("SPO3", 1, 2);
				RAM16X4D_replacement.addPort("DPO0", 1, 2);
				RAM16X4D_replacement.addPort("DPO1", 1, 2);
				RAM16X4D_replacement.addPort("DPO2", 1, 2);
				RAM16X4D_replacement.addPort("DPO3", 1, 2);
				
				/******Design******/
				EdifDesign design = new EdifDesign("RAM16X4D_replacement");
				topLevel.setTopDesign(design);
				topLevel.setTopCell(RAM16X4D_replacement);
				...
				EdifNet wclk_c = new EdifNet("wclk_c", RAM16X4D_replacement);
				EdifNet wclk = new EdifNet("wclk", RAM16X4D_replacement);
				EdifNet d0_c = new EdifNet("d0_c", RAM16X4D_replacement);
				EdifNet d0 = new EdifNet("d0", RAM16X4D_replacement);
				EdifNet d1_c = new EdifNet("d1_c", RAM16X4D_replacement);
				EdifNet d1 = new EdifNet("d1", RAM16X4D_replacement);
				EdifNet d2_c = new EdifNet("d2_c", RAM16X4D_replacement);
				EdifNet d2 = new EdifNet("d2", RAM16X4D_replacement);
				EdifNet d3_c = new EdifNet("d3_c", RAM16X4D_replacement);
				EdifNet d3 = new EdifNet("d3", RAM16X4D_replacement);
				EdifNet we_c = new EdifNet("we_c", RAM16X4D_replacement);
				EdifNet we = new EdifNet("we", RAM16X4D_replacement);
				EdifNet a0_c = new EdifNet("a0_c", RAM16X4D_replacement);
				EdifNet a0 = new EdifNet("a0", RAM16X4D_replacement);
				EdifNet a1_c = new EdifNet("a1_c", RAM16X4D_replacement);
				EdifNet a1 = new EdifNet("a1", RAM16X4D_replacement);
				EdifNet a2_c = new EdifNet("a2_c", RAM16X4D_replacement);
				EdifNet a2 = new EdifNet("a2", RAM16X4D_replacement);
				EdifNet a3_c = new EdifNet("a3_c", RAM16X4D_replacement);
				EdifNet a3 = new EdifNet("a3", RAM16X4D_replacement);
				EdifNet dpra0_c = new EdifNet("dpra0_c", RAM16X4D_replacement);
				EdifNet dpra0 = new EdifNet("dpra0", RAM16X4D_replacement);
				EdifNet dpra1_c = new EdifNet("dpra1_c", RAM16X4D_replacement);
				EdifNet dpra1 = new EdifNet("dpra1", RAM16X4D_replacement);
				EdifNet dpra2_c = new EdifNet("dpra2_c", RAM16X4D_replacement);
				EdifNet dpra2 = new EdifNet("dpra2", RAM16X4D_replacement);
				EdifNet dpra3_c = new EdifNet("dpra3_c", RAM16X4D_replacement);
				EdifNet dpra3 = new EdifNet("dpra3", RAM16X4D_replacement);
				EdifNet spo0_c = new EdifNet("spo0_c", RAM16X4D_replacement);
				EdifNet spo0 = new EdifNet("spo0", RAM16X4D_replacement);
				EdifNet spo1_c = new EdifNet("spo1_c", RAM16X4D_replacement);
				EdifNet spo1 = new EdifNet("spo1", RAM16X4D_replacement);
				EdifNet spo2_c = new EdifNet("spo2_c", RAM16X4D_replacement);
				EdifNet spo2 = new EdifNet("spo2", RAM16X4D_replacement);
				EdifNet spo3_c = new EdifNet("spo3_c", RAM16X4D_replacement);
				EdifNet spo3 = new EdifNet("spo3", RAM16X4D_replacement);
				EdifNet dpo0_c = new EdifNet("dpo0_c", RAM16X4D_replacement);
				EdifNet dpo0 = new EdifNet("dpo0", RAM16X4D_replacement);
				EdifNet dpo1_c = new EdifNet("dpo1_c", RAM16X4D_replacement);
				EdifNet dpo1 = new EdifNet("dpo1", RAM16X4D_replacement);
				EdifNet dpo2_c = new EdifNet("dpr2_c", RAM16X4D_replacement);
				EdifNet dpo2 = new EdifNet("dpo2", RAM16X4D_replacement);
				EdifNet dpo3_c = new EdifNet("dpo3_c", RAM16X4D_replacement);
				EdifNet dpo3 = new EdifNet("dpo3", RAM16X4D_replacement);
				...
				for(int i=0; i<WIRENUM; i++)
				{
					...
					wire[i] = new EdifNet(wirename, RAM16X4D_replacement);
				}
				...
				for(int i=0; i<NETNUM; i++)
				{
					...
					net[i] = new EdifNet(netname, RAM16X4D_replacement);
				}
				...
				for(int i=0; i<ENUM; i++)
				{
					...
					e[i] = new EdifNet(ename, RAM16X4D_replacement);
				}
				//Add all nets to the top level design
				RAM16X4D_replacement.addNet(wclk_c);
				RAM16X4D_replacement.addNet(wclk);
				RAM16X4D_replacement.addNet(d0_c);
				RAM16X4D_replacement.addNet(d0);
				RAM16X4D_replacement.addNet(d1_c);
				RAM16X4D_replacement.addNet(d1);
				RAM16X4D_replacement.addNet(d2_c);
				RAM16X4D_replacement.addNet(d2);
				RAM16X4D_replacement.addNet(d3_c);
				RAM16X4D_replacement.addNet(d3);
				RAM16X4D_replacement.addNet(we_c);
				RAM16X4D_replacement.addNet(we);
				RAM16X4D_replacement.addNet(a0_c);
				RAM16X4D_replacement.addNet(a0);
				RAM16X4D_replacement.addNet(a1_c);
				RAM16X4D_replacement.addNet(a1);
				RAM16X4D_replacement.addNet(a2_c);
				RAM16X4D_replacement.addNet(a2);
				RAM16X4D_replacement.addNet(a3_c);
				RAM16X4D_replacement.addNet(a3);
				RAM16X4D_replacement.addNet(dpra0_c);
				RAM16X4D_replacement.addNet(dpra0);
				RAM16X4D_replacement.addNet(dpra1_c);
				RAM16X4D_replacement.addNet(dpra1);
				RAM16X4D_replacement.addNet(dpra2_c);
				RAM16X4D_replacement.addNet(dpra2);
				RAM16X4D_replacement.addNet(dpra3_c);
				RAM16X4D_replacement.addNet(dpra3);
				RAM16X4D_replacement.addNet(spo0_c);
				RAM16X4D_replacement.addNet(spo0);
				RAM16X4D_replacement.addNet(spo1_c);
				RAM16X4D_replacement.addNet(spo1);
				RAM16X4D_replacement.addNet(spo2_c);
				RAM16X4D_replacement.addNet(spo2);
				RAM16X4D_replacement.addNet(spo3_c);
				RAM16X4D_replacement.addNet(spo3);
				RAM16X4D_replacement.addNet(dpo0_c);
				RAM16X4D_replacement.addNet(dpo0);
				RAM16X4D_replacement.addNet(dpo1_c);
				RAM16X4D_replacement.addNet(dpo1);
				RAM16X4D_replacement.addNet(dpo2_c);
				RAM16X4D_replacement.addNet(dpo2);
				RAM16X4D_replacement.addNet(dpo3_c);
				RAM16X4D_replacement.addNet(dpo3);
				for(int i=0; i<WIRENUM; i++)
				{
					RAM16X4D_replacement.addNet(wire[i]);
				}
				for(int i=0; i<NETNUM; i++)
				{
					RAM16X4D_replacement.addNet(net[i]);
				}
				for(int i=0; i<ENUM; i++)
				{
					RAM16X4D_replacement.addNet(e[i]);
				}
				...
				EdifCellInstance WE_ibuf = new EdifCellInstance("WE_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance D0_ibuf = new EdifCellInstance("D0_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance D1_ibuf = new EdifCellInstance("D1_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance D2_ibuf = new EdifCellInstance("D2_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance D3_ibuf = new EdifCellInstance("D3_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance WCLK_ibuf = new EdifCellInstance("WCLK_ibuf", RAM16X4D_replacement, BUFGP);
				EdifCellInstance A0_ibuf = new EdifCellInstance("A0_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance A1_ibuf = new EdifCellInstance("A1_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance A2_ibuf = new EdifCellInstance("A2_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance A3_ibuf = new EdifCellInstance("A3_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance DPRA0_ibuf = new EdifCellInstance("DPRA0_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance DPRA1_ibuf = new EdifCellInstance("DPRA1_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance DPRA2_ibuf = new EdifCellInstance("DPRA2_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance DPRA3_ibuf = new EdifCellInstance("DPRA3_ibuf", RAM16X4D_replacement, IBUF);
				EdifCellInstance SPO0_obuf = new EdifCellInstance("SPO0_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance SPO1_obuf = new EdifCellInstance("SPO1_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance SPO2_obuf = new EdifCellInstance("SPO2_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance SPO3_obuf = new EdifCellInstance("SPO3_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance DPO0_obuf = new EdifCellInstance("DPO0_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance DPO1_obuf = new EdifCellInstance("DPO1_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance DPO2_obuf = new EdifCellInstance("DPO2_obuf", RAM16X4D_replacement, OBUF);
				EdifCellInstance DPO3_obuf = new EdifCellInstance("DPO3_obuf", RAM16X4D_replacement, OBUF);
				//FDEs
				...
				for(int i=0; i<FDENUM; i++)
				{
					...
					FDE_[i] = new EdifCellInstance(fdename, RAM16X4D_replacement, FDE);
				}
				//LUT2s
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_[i] = new EdifCellInstance(lut2name, RAM16X4D_replacement, LUT2);
				}
				//LUT3s
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					LUT3_[i] = new EdifCellInstance(lut3name, RAM16X4D_replacement, LUT3);
				}
				//LUT4s
				...
				for(int i=0; i<LUT4NUM; i++)
				{
					...
					LUT4_[i] = new EdifCellInstance(lut4name, RAM16X4D_replacement, LUT4);
				}
				//MUXF5
				...
				for(int i=0; i<MUXF5NUM; i++)
				{
					...
					MUXF5_[i] = new EdifCellInstance(muxf5name, RAM16X4D_replacement, MUXF5);
				}
				//MUXF6
				...
				for(int i=0; i<MUXF6NUM; i++)
				{
					...
					MUXF6_[i] = new EdifCellInstance(muxf6name, RAM16X4D_replacement, MUXF6);
				}
				//Add all instances to the top level design
				RAM16X4D_replacement.addSubCell(WE_ibuf);
				RAM16X4D_replacement.addSubCell(D0_ibuf);
				RAM16X4D_replacement.addSubCell(D1_ibuf);
				RAM16X4D_replacement.addSubCell(D2_ibuf);
				RAM16X4D_replacement.addSubCell(D3_ibuf);
				RAM16X4D_replacement.addSubCell(WCLK_ibuf);
				RAM16X4D_replacement.addSubCell(A0_ibuf);
				RAM16X4D_replacement.addSubCell(A1_ibuf);
				RAM16X4D_replacement.addSubCell(A2_ibuf);
				RAM16X4D_replacement.addSubCell(A3_ibuf);
				RAM16X4D_replacement.addSubCell(DPRA0_ibuf);
				RAM16X4D_replacement.addSubCell(DPRA1_ibuf);
				RAM16X4D_replacement.addSubCell(DPRA2_ibuf);
				RAM16X4D_replacement.addSubCell(DPRA3_ibuf);
				RAM16X4D_replacement.addSubCell(SPO0_obuf);
				RAM16X4D_replacement.addSubCell(SPO1_obuf);
				RAM16X4D_replacement.addSubCell(SPO2_obuf);
				RAM16X4D_replacement.addSubCell(SPO3_obuf);
				RAM16X4D_replacement.addSubCell(DPO0_obuf);
				RAM16X4D_replacement.addSubCell(DPO1_obuf);
				RAM16X4D_replacement.addSubCell(DPO2_obuf);
				RAM16X4D_replacement.addSubCell(DPO3_obuf);
				for(int i=0; i<FDENUM; i++)
				{
					RAM16X4D_replacement.addSubCell(FDE_[i]);
				}
				for(int i=0; i<LUT2NUM; i++)
				{
					RAM16X4D_replacement.addSubCell(LUT2_[i]);
				}
				for(int i=0; i<LUT3NUM; i++)
				{
					RAM16X4D_replacement.addSubCell(LUT3_[i]);
				}
				for(int i=0; i<LUT4NUM; i++)
				{
					RAM16X4D_replacement.addSubCell(LUT4_[i]);
				}
				for(int i=0; i<MUXF5NUM; i++)
				{
					RAM16X4D_replacement.addSubCell(MUXF5_[i]);
				}
				for(int i=0; i<MUXF6NUM; i++)
				{
					RAM16X4D_replacement.addSubCell(MUXF6_[i]);
				}
				
				/******Interface******/
				//Interface of buffers
				EdifCellInterface RAM16X4D_replacement_interface = new EdifCellInterface(RAM16X4D_replacement);
				...
				/******Ports******/
				//RAM16X4D_replacement
				EdifPort RAM16X4D_replacement_interface_WE = new EdifPort(RAM16X4D_replacement_interface, "WE", 1, 1);
				EdifPort RAM16X4D_replacement_interface_D0 = new EdifPort(RAM16X4D_replacement_interface, "D0", 1, 1);
				EdifPort RAM16X4D_replacement_interface_D1 = new EdifPort(RAM16X4D_replacement_interface, "D1", 1, 1);
				EdifPort RAM16X4D_replacement_interface_D2 = new EdifPort(RAM16X4D_replacement_interface, "D2", 1, 1);
				EdifPort RAM16X4D_replacement_interface_D3 = new EdifPort(RAM16X4D_replacement_interface, "D3", 1, 1);
				EdifPort RAM16X4D_replacement_interface_WCLK = new EdifPort(RAM16X4D_replacement_interface, "WCLK", 1, 1);
				EdifPort RAM16X4D_replacement_interface_A0 = new EdifPort(RAM16X4D_replacement_interface, "A0", 1, 1);
				EdifPort RAM16X4D_replacement_interface_A1 = new EdifPort(RAM16X4D_replacement_interface, "A1", 1, 1);
				EdifPort RAM16X4D_replacement_interface_A2 = new EdifPort(RAM16X4D_replacement_interface, "A2", 1, 1);
				EdifPort RAM16X4D_replacement_interface_A3 = new EdifPort(RAM16X4D_replacement_interface, "A3", 1, 1);
				EdifPort RAM16X4D_replacement_interface_DPRA0 = new EdifPort(RAM16X4D_replacement_interface, "DPRA0", 1, 1);
				EdifPort RAM16X4D_replacement_interface_DPRA1 = new EdifPort(RAM16X4D_replacement_interface, "DPRA1", 1, 1);
				EdifPort RAM16X4D_replacement_interface_DPRA2 = new EdifPort(RAM16X4D_replacement_interface, "DPRA2", 1, 1);
				EdifPort RAM16X4D_replacement_interface_DPRA3 = new EdifPort(RAM16X4D_replacement_interface, "DPRA3", 1, 1);
				EdifPort RAM16X4D_replacement_interface_SPO0 = new EdifPort(RAM16X4D_replacement_interface, "SPO0", 1, 2);
				EdifPort RAM16X4D_replacement_interface_SPO1 = new EdifPort(RAM16X4D_replacement_interface, "SPO1", 1, 2);
				EdifPort RAM16X4D_replacement_interface_SPO2 = new EdifPort(RAM16X4D_replacement_interface, "SPO2", 1, 2);
				EdifPort RAM16X4D_replacement_interface_SPO3 = new EdifPort(RAM16X4D_replacement_interface, "SPO3", 1, 2);
				EdifPort RAM16X4D_replacement_interface_DPO0 = new EdifPort(RAM16X4D_replacement_interface, "DPO0", 1, 2);
				EdifPort RAM16X4D_replacement_interface_DPO1 = new EdifPort(RAM16X4D_replacement_interface, "DPO1", 1, 2);
				EdifPort RAM16X4D_replacement_interface_DPO2 = new EdifPort(RAM16X4D_replacement_interface, "DPO2", 1, 2);
				EdifPort RAM16X4D_replacement_interface_DPO3 = new EdifPort(RAM16X4D_replacement_interface, "DPO3", 1, 2);
				RAM16X4D_replacement_interface.addPort("WE", 1, 1);
				RAM16X4D_replacement_interface.addPort("D0", 1, 1);
				RAM16X4D_replacement_interface.addPort("D1", 1, 1);
				RAM16X4D_replacement_interface.addPort("D2", 1, 1);
				RAM16X4D_replacement_interface.addPort("D3", 1, 1);
				RAM16X4D_replacement_interface.addPort("WCLK", 1, 1);
				RAM16X4D_replacement_interface.addPort("A0", 1, 1);
				RAM16X4D_replacement_interface.addPort("A1", 1, 1);
				RAM16X4D_replacement_interface.addPort("A2", 1, 1);
				RAM16X4D_replacement_interface.addPort("A3", 1, 1);
				RAM16X4D_replacement_interface.addPort("DPRA0", 1, 1);
				RAM16X4D_replacement_interface.addPort("DPRA1", 1, 1);
				RAM16X4D_replacement_interface.addPort("DPRA2", 1, 1);
				RAM16X4D_replacement_interface.addPort("DPRA3", 1, 1);
				RAM16X4D_replacement_interface.addPort("SPO0", 1, 2);
				RAM16X4D_replacement_interface.addPort("SPO1", 1, 2);
				RAM16X4D_replacement_interface.addPort("SPO2", 1, 2);
				RAM16X4D_replacement_interface.addPort("SPO3", 1, 2);
				RAM16X4D_replacement_interface.addPort("DPO0", 1, 2);
				RAM16X4D_replacement_interface.addPort("DPO1", 1, 2);
				RAM16X4D_replacement_interface.addPort("DPO2", 1, 2);
				RAM16X4D_replacement_interface.addPort("DPO3", 1, 2);
				//WE_ibuf
				...
				EdifPortRef RAM16X4D_replacement_WE = new EdifPortRef(we, RAM16X4D_replacement_interface_WE.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_D0 = new EdifPortRef(d0, RAM16X4D_replacement_interface_D0.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_D1 = new EdifPortRef(d1, RAM16X4D_replacement_interface_D1.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_D2 = new EdifPortRef(d2, RAM16X4D_replacement_interface_D2.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_D3 = new EdifPortRef(d3, RAM16X4D_replacement_interface_D3.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_WCLK = new EdifPortRef(wclk, RAM16X4D_replacement_interface_WCLK.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_A0 = new EdifPortRef(a0, RAM16X4D_replacement_interface_A0.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_A1 = new EdifPortRef(a1, RAM16X4D_replacement_interface_A1.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_A2 = new EdifPortRef(a2, RAM16X4D_replacement_interface_A2.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_A3 = new EdifPortRef(a3, RAM16X4D_replacement_interface_A3.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPRA0 = new EdifPortRef(dpra0, RAM16X4D_replacement_interface_DPRA0.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPRA1 = new EdifPortRef(dpra1, RAM16X4D_replacement_interface_DPRA1.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPRA2 = new EdifPortRef(dpra2, RAM16X4D_replacement_interface_DPRA2.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPRA3 = new EdifPortRef(dpra3, RAM16X4D_replacement_interface_DPRA3.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_SPO0 = new EdifPortRef(spo0, RAM16X4D_replacement_interface_SPO0.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_SPO1 = new EdifPortRef(spo1, RAM16X4D_replacement_interface_SPO1.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_SPO2 = new EdifPortRef(spo2, RAM16X4D_replacement_interface_SPO2.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_SPO3 = new EdifPortRef(spo3, RAM16X4D_replacement_interface_SPO3.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPO0 = new EdifPortRef(dpo0, RAM16X4D_replacement_interface_DPO0.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPO1 = new EdifPortRef(dpo1, RAM16X4D_replacement_interface_DPO1.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPO2 = new EdifPortRef(dpo2, RAM16X4D_replacement_interface_DPO2.getSingleBitPort(0), null);
				EdifPortRef RAM16X4D_replacement_DPO3 = new EdifPortRef(dpo3, RAM16X4D_replacement_interface_DPO3.getSingleBitPort(0), null);
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_O[i] = new EdifPortRef(net[14*8+i], LUT2Interface_O[i].getSingleBitPort(0), LUT2_[i]);
				}
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					else	//DPO
					{
						if(q!=8)
						{
							...
							LUT3_I1[i] = new EdifPortRef(wire[q+16*(d-4)], LUT3Interface_I1[i].getSingleBitPort(0), LUT3_[i]);
							LUT3_I2[i] = new EdifPortRef(wire[q+16*(d-4)+8], LUT3Interface_I2[i].getSingleBitPort(0), LUT3_[i]);
							LUT3_O[i] = new EdifPortRef(net[q+14*d], LUT3Interface_O[i].getSingleBitPort(0), LUT3_[i]);
						}
						else
						{
				...
				//we
				we.addPortConnection(RAM16X4D_replacement_WE);
				...
				//d0
				d0.addPortConnection(RAM16X4D_replacement_D0);
				...
				//d1
				d1.addPortConnection(RAM16X4D_replacement_D1);
				...
				//d2
				d2.addPortConnection(RAM16X4D_replacement_D2);
				...
				//d3
				d3.addPortConnection(RAM16X4D_replacement_D3);
				...
				wclk.addPortConnection(RAM16X4D_replacement_WCLK);
				//wclk_c
				...
				//a0
				a0.addPortConnection(RAM16X4D_replacement_A0);
				...
				//a1
				a1.addPortConnection(RAM16X4D_replacement_A1);
				...
				//a2
				a2.addPortConnection(RAM16X4D_replacement_A2);
				...
				//a3
				a3.addPortConnection(RAM16X4D_replacement_A3);
				...
				//dpra0
				dpra0.addPortConnection(RAM16X4D_replacement_DPRA0);
				...
				//dpra1
				dpra1.addPortConnection(RAM16X4D_replacement_DPRA1);
				...
				//dpra2
				dpra2.addPortConnection(RAM16X4D_replacement_DPRA2);
				...
				//dpra3
				dpra3.addPortConnection(RAM16X4D_replacement_DPRA3);
				...
				for(int i=0; i<FDENUM; i++)
				{
					...
					if(q<8)
					{
						...
						wire[i].addPortConnection(LUT3_I1[d*9+q+36]);
					}
					else
					{
						wire[i].addPortConnection(LUT3_I2[d*9+q-8]);
						wire[i].addPortConnection(LUT3_I2[d*9+q-8+36]);
					}
				}
				//e
				for(int i=0; i<ENUM; i++)
	...
	public static void Replace(EdifLibraryManager libManager, EdifCell RAM16X4D_replacement,
			...
			EdifNet spo0, EdifNet spo1, EdifNet spo2, EdifNet spo3, EdifNet dpo0, EdifNet dpo1, EdifNet dpo2, EdifNet dpo3) {
		try{
			try{
				/******Cells******/
				...
				//dpo0
				dpo0.addPortConnection(LUT3_O[44]);
				//dpo1
				dpo1.addPortConnection(LUT3_O[53]);
				//dpo2
				dpo2.addPortConnection(LUT3_O[62]);
				//dpo3
				dpo3.addPortConnection(LUT3_O[71]);
				//wires
				for(int i=0; i<FDENUM; i++)
				{
					int d = i/16;
