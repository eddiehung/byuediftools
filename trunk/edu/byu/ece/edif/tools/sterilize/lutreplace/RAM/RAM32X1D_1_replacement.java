...
/**
 * Generates the EDIF file for RAM32X1D_1
 * Includes: 32 FDE_1s, 2 32-1 MUXs(19 LUT3s, 8 MUXF5s, and 4 MUXF6s for each), 1 5-32  decoder(6 LUT2s, 32 LUT4s).
 * 
 * @author Yubo Li
 *
 */

public class RAM32X1D_1_replacement{
	public static void main(String args[]){
		
		String outputFileName = "RAM32X1D_1_replacement.edf";
		
		try{
			/******Environment and Environment manager******/
			EdifEnvironment topLevel = new EdifEnvironment("RAM32X1D_1_replacement");
			...
			try{
				...
				EdifCell RAM32X1D_1_replacement = new EdifCell(work, "RAM32X1D_1_replacement");
				RAM32X1D_1_replacement.addPort("WE", 1, 1);
				RAM32X1D_1_replacement.addPort("D", 1, 1);
				RAM32X1D_1_replacement.addPort("WCLK", 1, 1);
				RAM32X1D_1_replacement.addPort("A0", 1, 1);
				RAM32X1D_1_replacement.addPort("A1", 1, 1);
				RAM32X1D_1_replacement.addPort("A2", 1, 1);
				RAM32X1D_1_replacement.addPort("A3", 1, 1);
				RAM32X1D_1_replacement.addPort("A4", 1, 1);
				RAM32X1D_1_replacement.addPort("DPRA0", 1, 1);
				RAM32X1D_1_replacement.addPort("DPRA1", 1, 1);
				RAM32X1D_1_replacement.addPort("DPRA2", 1, 1);
				RAM32X1D_1_replacement.addPort("DPRA3", 1, 1);
				RAM32X1D_1_replacement.addPort("DPRA4", 1, 1);
				RAM32X1D_1_replacement.addPort("SPO", 1, 2);
				RAM32X1D_1_replacement.addPort("DPO", 1, 2);
				
				/******Design******/
				EdifDesign design = new EdifDesign("RAM32X1D_1_replacement");
				topLevel.setTopDesign(design);
				topLevel.setTopCell(RAM32X1D_1_replacement);
				...
				EdifNet wclk_c = new EdifNet("wclk_c", RAM32X1D_1_replacement);
				EdifNet wclk = new EdifNet("wclk", RAM32X1D_1_replacement);
				EdifNet d_c = new EdifNet("d_c", RAM32X1D_1_replacement);
				EdifNet d = new EdifNet("d", RAM32X1D_1_replacement);
				EdifNet we_c = new EdifNet("we_c", RAM32X1D_1_replacement);
				EdifNet we = new EdifNet("we", RAM32X1D_1_replacement);
				EdifNet a0_c = new EdifNet("a0_c", RAM32X1D_1_replacement);
				EdifNet a0 = new EdifNet("a0", RAM32X1D_1_replacement);
				EdifNet a1_c = new EdifNet("a1_c", RAM32X1D_1_replacement);
				EdifNet a1 = new EdifNet("a1", RAM32X1D_1_replacement);
				EdifNet a2_c = new EdifNet("a2_c", RAM32X1D_1_replacement);
				EdifNet a2 = new EdifNet("a2", RAM32X1D_1_replacement);
				EdifNet a3_c = new EdifNet("a3_c", RAM32X1D_1_replacement);
				EdifNet a3 = new EdifNet("a3", RAM32X1D_1_replacement);
				EdifNet a4_c = new EdifNet("a4_c", RAM32X1D_1_replacement);
				EdifNet a4 = new EdifNet("a4", RAM32X1D_1_replacement);
				EdifNet dpra0_c = new EdifNet("dpra0_c", RAM32X1D_1_replacement);
				EdifNet dpra0 = new EdifNet("dpra0", RAM32X1D_1_replacement);
				EdifNet dpra1_c = new EdifNet("dpra1_c", RAM32X1D_1_replacement);
				EdifNet dpra1 = new EdifNet("dpra1", RAM32X1D_1_replacement);
				EdifNet dpra2_c = new EdifNet("dpra2_c", RAM32X1D_1_replacement);
				EdifNet dpra2 = new EdifNet("dpra2", RAM32X1D_1_replacement);
				EdifNet dpra3_c = new EdifNet("dpra3_c", RAM32X1D_1_replacement);
				EdifNet dpra3 = new EdifNet("dpra3", RAM32X1D_1_replacement);
				EdifNet dpra4_c = new EdifNet("dpra4_c", RAM32X1D_1_replacement);
				EdifNet dpra4 = new EdifNet("dpra4", RAM32X1D_1_replacement);
				EdifNet spo_c = new EdifNet("spo_c", RAM32X1D_1_replacement);
				EdifNet spo = new EdifNet("spo", RAM32X1D_1_replacement);
				EdifNet dpo_c = new EdifNet("dpo_c", RAM32X1D_1_replacement);
				EdifNet dpo = new EdifNet("dpo", RAM32X1D_1_replacement);
				...
				for(int i=0; i<WIRENUM; i++)
				{
					...
					wire[i] = new EdifNet(wirename, RAM32X1D_1_replacement);
				}
				...
				for(int i=0; i<NETNUM; i++)
				{
					...
					net[i] = new EdifNet(netname, RAM32X1D_1_replacement);
				}
				...
				for(int i=0; i<ENUM; i++)
				{
					...
					e[i] = new EdifNet(ename, RAM32X1D_1_replacement);
				}
				//Add all nets to the top level design
				RAM32X1D_1_replacement.addNet(wclk_c);
				RAM32X1D_1_replacement.addNet(wclk);
				RAM32X1D_1_replacement.addNet(d_c);
				RAM32X1D_1_replacement.addNet(d);
				RAM32X1D_1_replacement.addNet(we_c);
				RAM32X1D_1_replacement.addNet(we);
				RAM32X1D_1_replacement.addNet(a0_c);
				RAM32X1D_1_replacement.addNet(a0);
				RAM32X1D_1_replacement.addNet(a1_c);
				RAM32X1D_1_replacement.addNet(a1);
				RAM32X1D_1_replacement.addNet(a2_c);
				RAM32X1D_1_replacement.addNet(a2);
				RAM32X1D_1_replacement.addNet(a3_c);
				RAM32X1D_1_replacement.addNet(a3);
				RAM32X1D_1_replacement.addNet(a4_c);
				RAM32X1D_1_replacement.addNet(a4);
				RAM32X1D_1_replacement.addNet(dpra0_c);
				RAM32X1D_1_replacement.addNet(dpra0);
				RAM32X1D_1_replacement.addNet(dpra1_c);
				RAM32X1D_1_replacement.addNet(dpra1);
				RAM32X1D_1_replacement.addNet(dpra2_c);
				RAM32X1D_1_replacement.addNet(dpra2);
				RAM32X1D_1_replacement.addNet(dpra3_c);
				RAM32X1D_1_replacement.addNet(dpra3);
				RAM32X1D_1_replacement.addNet(dpra4_c);
				RAM32X1D_1_replacement.addNet(dpra4);
				RAM32X1D_1_replacement.addNet(spo_c);
				RAM32X1D_1_replacement.addNet(spo);
				RAM32X1D_1_replacement.addNet(dpo_c);
				RAM32X1D_1_replacement.addNet(dpo);
				for(int i=0; i<WIRENUM; i++)
				{
					RAM32X1D_1_replacement.addNet(wire[i]);
				}
				for(int i=0; i<NETNUM; i++)
				{
					RAM32X1D_1_replacement.addNet(net[i]);
				}
				for(int i=0; i<ENUM; i++)
				{
					RAM32X1D_1_replacement.addNet(e[i]);
				}
				...
				EdifCellInstance WE_ibuf = new EdifCellInstance("WE_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance D_ibuf = new EdifCellInstance("D_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance WCLK_ibuf = new EdifCellInstance("WCLK_ibuf", RAM32X1D_1_replacement, BUFGP);
				EdifCellInstance A0_ibuf = new EdifCellInstance("A0_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance A1_ibuf = new EdifCellInstance("A1_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance A2_ibuf = new EdifCellInstance("A2_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance A3_ibuf = new EdifCellInstance("A3_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance A4_ibuf = new EdifCellInstance("A4_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance DPRA0_ibuf = new EdifCellInstance("DPRA0_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance DPRA1_ibuf = new EdifCellInstance("DPRA1_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance DPRA2_ibuf = new EdifCellInstance("DPRA2_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance DPRA3_ibuf = new EdifCellInstance("DPRA3_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance DPRA4_ibuf = new EdifCellInstance("DPRA4_ibuf", RAM32X1D_1_replacement, IBUF);
				EdifCellInstance SPO_obuf = new EdifCellInstance("SPO_obuf", RAM32X1D_1_replacement, OBUF);
				EdifCellInstance DPO_obuf = new EdifCellInstance("DPO_obuf", RAM32X1D_1_replacement, OBUF);
				//FDE_1s
				...
				for(int i=0; i<FDE_1NUM; i++)
				{
					...
					FDE_1_[i] = new EdifCellInstance(fdename, RAM32X1D_1_replacement, FDE_1);
				}
				//LUT2s
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_[i] = new EdifCellInstance(lut2name, RAM32X1D_1_replacement, LUT2);
				}
				//LUT3s
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					LUT3_[i] = new EdifCellInstance(lut3name, RAM32X1D_1_replacement, LUT3);
				}
				//LUT4s
				...
				for(int i=0; i<LUT4NUM; i++)
				{
					...
					LUT4_[i] = new EdifCellInstance(lut4name, RAM32X1D_1_replacement, LUT4);
				}
				//MUXF5
				...
				for(int i=0; i<MUXF5NUM; i++)
				{
					...
					MUXF5_[i] = new EdifCellInstance(muxf5name, RAM32X1D_1_replacement, MUXF5);
				}
				//MUXF6
				...
				for(int i=0; i<MUXF6NUM; i++)
				{
					...
					MUXF6_[i] = new EdifCellInstance(muxf6name, RAM32X1D_1_replacement, MUXF6);
				}
				//Add all instances to the top level design
				RAM32X1D_1_replacement.addSubCell(WE_ibuf);
				RAM32X1D_1_replacement.addSubCell(D_ibuf);
				RAM32X1D_1_replacement.addSubCell(WCLK_ibuf);
				RAM32X1D_1_replacement.addSubCell(A0_ibuf);
				RAM32X1D_1_replacement.addSubCell(A1_ibuf);
				RAM32X1D_1_replacement.addSubCell(A2_ibuf);
				RAM32X1D_1_replacement.addSubCell(A3_ibuf);
				RAM32X1D_1_replacement.addSubCell(A4_ibuf);
				RAM32X1D_1_replacement.addSubCell(DPRA0_ibuf);
				RAM32X1D_1_replacement.addSubCell(DPRA1_ibuf);
				RAM32X1D_1_replacement.addSubCell(DPRA2_ibuf);
				RAM32X1D_1_replacement.addSubCell(DPRA3_ibuf);
				RAM32X1D_1_replacement.addSubCell(DPRA4_ibuf);
				RAM32X1D_1_replacement.addSubCell(SPO_obuf);
				RAM32X1D_1_replacement.addSubCell(DPO_obuf);
				for(int i=0; i<FDE_1NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(FDE_1_[i]);
				}
				for(int i=0; i<LUT2NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(LUT2_[i]);
				}
				for(int i=0; i<LUT3NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(LUT3_[i]);
				}
				for(int i=0; i<LUT4NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(LUT4_[i]);
				}
				for(int i=0; i<MUXF5NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(MUXF5_[i]);
				}
				for(int i=0; i<MUXF6NUM; i++)
				{
					RAM32X1D_1_replacement.addSubCell(MUXF6_[i]);
				}
				
				/******Interface******/
				//Interface of buffers
				EdifCellInterface RAM32X1D_1_replacement_interface = new EdifCellInterface(RAM32X1D_1_replacement);
				...
				/******Ports******/
				//RAM32X1D_1_replacement
				EdifPort RAM32X1D_1_replacement_interface_WE = new EdifPort(RAM32X1D_1_replacement_interface, "WE", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_D = new EdifPort(RAM32X1D_1_replacement_interface, "D", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_WCLK = new EdifPort(RAM32X1D_1_replacement_interface, "WCLK", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_A0 = new EdifPort(RAM32X1D_1_replacement_interface, "A0", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_A1 = new EdifPort(RAM32X1D_1_replacement_interface, "A1", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_A2 = new EdifPort(RAM32X1D_1_replacement_interface, "A2", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_A3 = new EdifPort(RAM32X1D_1_replacement_interface, "A3", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_A4 = new EdifPort(RAM32X1D_1_replacement_interface, "A4", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_DPRA0 = new EdifPort(RAM32X1D_1_replacement_interface, "DPRA0", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_DPRA1 = new EdifPort(RAM32X1D_1_replacement_interface, "DPRA1", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_DPRA2 = new EdifPort(RAM32X1D_1_replacement_interface, "DPRA2", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_DPRA3 = new EdifPort(RAM32X1D_1_replacement_interface, "DPRA3", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_DPRA4 = new EdifPort(RAM32X1D_1_replacement_interface, "DPRA4", 1, 1);
				EdifPort RAM32X1D_1_replacement_interface_SPO = new EdifPort(RAM32X1D_1_replacement_interface, "SPO", 1, 2);
				EdifPort RAM32X1D_1_replacement_interface_DPO = new EdifPort(RAM32X1D_1_replacement_interface, "DPO", 1, 2);
				RAM32X1D_1_replacement_interface.addPort("WE", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("D", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("WCLK", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("A0", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("A1", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("A2", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("A3", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("A4", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("DPRA0", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("DPRA1", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("DPRA2", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("DPRA3", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("DPRA4", 1, 1);
				RAM32X1D_1_replacement_interface.addPort("SPO", 1, 2);
				RAM32X1D_1_replacement_interface.addPort("DPO", 1, 2);
				//WE_ibuf
				...
				EdifPortRef RAM32X1D_1_replacement_WE = new EdifPortRef(we, RAM32X1D_1_replacement_interface_WE.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_D = new EdifPortRef(d, RAM32X1D_1_replacement_interface_D.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_WCLK = new EdifPortRef(wclk, RAM32X1D_1_replacement_interface_WCLK.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_A0 = new EdifPortRef(a0, RAM32X1D_1_replacement_interface_A0.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_A1 = new EdifPortRef(a1, RAM32X1D_1_replacement_interface_A1.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_A2 = new EdifPortRef(a2, RAM32X1D_1_replacement_interface_A2.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_A3 = new EdifPortRef(a3, RAM32X1D_1_replacement_interface_A3.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_A4 = new EdifPortRef(a4, RAM32X1D_1_replacement_interface_A4.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPRA0 = new EdifPortRef(dpra0, RAM32X1D_1_replacement_interface_DPRA0.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPRA1 = new EdifPortRef(dpra1, RAM32X1D_1_replacement_interface_DPRA1.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPRA2 = new EdifPortRef(dpra2, RAM32X1D_1_replacement_interface_DPRA2.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPRA3 = new EdifPortRef(dpra3, RAM32X1D_1_replacement_interface_DPRA3.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPRA4 = new EdifPortRef(dpra4, RAM32X1D_1_replacement_interface_DPRA4.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_SPO = new EdifPortRef(spo, RAM32X1D_1_replacement_interface_SPO.getSingleBitPort(0), null);
				EdifPortRef RAM32X1D_1_replacement_DPO = new EdifPortRef(dpo, RAM32X1D_1_replacement_interface_DPO.getSingleBitPort(0), null);
				...
				//we
				we.addPortConnection(RAM32X1D_1_replacement_WE);
				...
				//d
				d.addPortConnection(RAM32X1D_1_replacement_D);
				...
				wclk.addPortConnection(RAM32X1D_1_replacement_WCLK);
				//wclk_c
				...
				//a0
				a0.addPortConnection(RAM32X1D_1_replacement_A0);
				...
				//a1
				a1.addPortConnection(RAM32X1D_1_replacement_A1);
				...
				//a2
				a2.addPortConnection(RAM32X1D_1_replacement_A2);
				...
				//a3
				a3.addPortConnection(RAM32X1D_1_replacement_A3);
				...
				//a4
				a4.addPortConnection(RAM32X1D_1_replacement_A4);
				...
				//dpra0
				dpra0.addPortConnection(RAM32X1D_1_replacement_DPRA0);
				...
				//dpra1
				dpra1.addPortConnection(RAM32X1D_1_replacement_DPRA1);
				...
				//dpra2
				dpra2.addPortConnection(RAM32X1D_1_replacement_DPRA2);
				...
				//dpra3
				dpra3.addPortConnection(RAM32X1D_1_replacement_DPRA3);
				...
				//dpra4
				dpra4.addPortConnection(RAM32X1D_1_replacement_DPRA4);
	...
	public static void Replace(EdifLibraryManager libManager, EdifCell RAM32X1D_1_replacement, long INIT,
