...
/**
 *
 * Testbench used to compare logic RAM implementation with JHDL Xilinx
 * RAM primitives.
 *
...
public class tb_jhdlRAM extends Logic implements TestBench {
    ...
    public tb_jhdlRAM(Node parent) {
        ...
        clockDriver(clk, "01");
        jhdlramtest realram = new jhdlramtest(this, 
                                              indatajhdl,
                                              wejhdl,
                                              clk,
                                              wajhdl,
        ...
        jhdllogicramtest logicram = new jhdllogicramtest(this, 
                                                         indatalogic,
                                                         welogic,
                                                         clk,
                                                         walogic,
