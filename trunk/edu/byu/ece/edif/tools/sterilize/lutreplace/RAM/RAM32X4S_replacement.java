/* Generates the EDIF file for RAM32X4S
 *
...
/**
 * Generates the EDIF file for RAM32X4S
 * Includes: 128 FDEs, 4 32-1 MUXs(19 LUT3s, 8 MUXF5s, and 4 MUXF6s for each), 1 5-32 decoder(6 LUT2s, 32 LUT4s).
 * 
 * @author Yubo Li
 *
 */

public class RAM32X4S_replacement{
	public static void main(String args[]){
		
		String outputFileName = "RAM32X4S_replacement.edf";
		
		try{
			/******Environment and Environment manager******/
			EdifEnvironment topLevel = new EdifEnvironment("RAM32X4S_replacement");
			...
			try{
				...
				EdifCell RAM32X4S_replacement = new EdifCell(work, "RAM32X4S_replacement");
				RAM32X4S_replacement.addPort("WE", 1, 1);
				RAM32X4S_replacement.addPort("D0", 1, 1);
				RAM32X4S_replacement.addPort("D1", 1, 1);
				RAM32X4S_replacement.addPort("D2", 1, 1);
				RAM32X4S_replacement.addPort("D3", 1, 1);
				RAM32X4S_replacement.addPort("WCLK", 1, 1);
				RAM32X4S_replacement.addPort("A0", 1, 1);
				RAM32X4S_replacement.addPort("A1", 1, 1);
				RAM32X4S_replacement.addPort("A2", 1, 1);
				RAM32X4S_replacement.addPort("A3", 1, 1);
				RAM32X4S_replacement.addPort("A4", 1, 1);
				RAM32X4S_replacement.addPort("O0", 1, 2);
				RAM32X4S_replacement.addPort("O1", 1, 2);
				RAM32X4S_replacement.addPort("O2", 1, 2);
				RAM32X4S_replacement.addPort("O3", 1, 2);
				
				/******Design******/
				EdifDesign design = new EdifDesign("RAM32X4S_replacement");
				topLevel.setTopDesign(design);
				topLevel.setTopCell(RAM32X4S_replacement);
				...
				EdifNet wclk_c = new EdifNet("wclk_c", RAM32X4S_replacement);
				EdifNet wclk = new EdifNet("wclk", RAM32X4S_replacement);
				EdifNet d0_c = new EdifNet("d0_c", RAM32X4S_replacement);
				EdifNet d0 = new EdifNet("d0", RAM32X4S_replacement);
				EdifNet d1_c = new EdifNet("d1_c", RAM32X4S_replacement);
				EdifNet d1 = new EdifNet("d1", RAM32X4S_replacement);
				EdifNet d2_c = new EdifNet("d2_c", RAM32X4S_replacement);
				EdifNet d2 = new EdifNet("d2", RAM32X4S_replacement);
				EdifNet d3_c = new EdifNet("d3_c", RAM32X4S_replacement);
				EdifNet d3 = new EdifNet("d3", RAM32X4S_replacement);
				EdifNet we_c = new EdifNet("we_c", RAM32X4S_replacement);
				EdifNet we = new EdifNet("we", RAM32X4S_replacement);
				EdifNet a0_c = new EdifNet("a0_c", RAM32X4S_replacement);
				EdifNet a0 = new EdifNet("a0", RAM32X4S_replacement);
				EdifNet a1_c = new EdifNet("a1_c", RAM32X4S_replacement);
				EdifNet a1 = new EdifNet("a1", RAM32X4S_replacement);
				EdifNet a2_c = new EdifNet("a2_c", RAM32X4S_replacement);
				EdifNet a2 = new EdifNet("a2", RAM32X4S_replacement);
				EdifNet a3_c = new EdifNet("a3_c", RAM32X4S_replacement);
				EdifNet a3 = new EdifNet("a3", RAM32X4S_replacement);
				EdifNet a4_c = new EdifNet("a4_c", RAM32X4S_replacement);
				EdifNet a4 = new EdifNet("a4", RAM32X4S_replacement);
				EdifNet o0_c = new EdifNet("o0_c", RAM32X4S_replacement);
				EdifNet o0 = new EdifNet("o0", RAM32X4S_replacement);
				EdifNet o1_c = new EdifNet("o1_c", RAM32X4S_replacement);
				EdifNet o1 = new EdifNet("o1", RAM32X4S_replacement);
				EdifNet o2_c = new EdifNet("o2_c", RAM32X4S_replacement);
				EdifNet o2 = new EdifNet("o2", RAM32X4S_replacement);
				EdifNet o3_c = new EdifNet("o3_c", RAM32X4S_replacement);
				EdifNet o3 = new EdifNet("o3", RAM32X4S_replacement);
				...
				for(int i=0; i<WIRENUM; i++)
				{
					...
					wire[i] = new EdifNet(wirename, RAM32X4S_replacement);
				}
				...
				for(int i=0; i<NETNUM; i++)
				{
					...
					net[i] = new EdifNet(netname, RAM32X4S_replacement);
				}
				...
				for(int i=0; i<ENUM; i++)
				{
					...
					e[i] = new EdifNet(ename, RAM32X4S_replacement);
				}
				//Add all nets to the top level design
				RAM32X4S_replacement.addNet(wclk_c);
				RAM32X4S_replacement.addNet(wclk);
				RAM32X4S_replacement.addNet(d0_c);
				RAM32X4S_replacement.addNet(d0);
				RAM32X4S_replacement.addNet(d1_c);
				RAM32X4S_replacement.addNet(d1);
				RAM32X4S_replacement.addNet(d2_c);
				RAM32X4S_replacement.addNet(d2);
				RAM32X4S_replacement.addNet(d3_c);
				RAM32X4S_replacement.addNet(d3);
				RAM32X4S_replacement.addNet(we_c);
				RAM32X4S_replacement.addNet(we);
				RAM32X4S_replacement.addNet(a0_c);
				RAM32X4S_replacement.addNet(a0);
				RAM32X4S_replacement.addNet(a1_c);
				RAM32X4S_replacement.addNet(a1);
				RAM32X4S_replacement.addNet(a2_c);
				RAM32X4S_replacement.addNet(a2);
				RAM32X4S_replacement.addNet(a3_c);
				RAM32X4S_replacement.addNet(a3);
				RAM32X4S_replacement.addNet(a4_c);
				RAM32X4S_replacement.addNet(a4);
				RAM32X4S_replacement.addNet(o0_c);
				RAM32X4S_replacement.addNet(o0);
				RAM32X4S_replacement.addNet(o1_c);
				RAM32X4S_replacement.addNet(o1);
				RAM32X4S_replacement.addNet(o2_c);
				RAM32X4S_replacement.addNet(o2);
				RAM32X4S_replacement.addNet(o3_c);
				RAM32X4S_replacement.addNet(o3);
				for(int i=0; i<WIRENUM; i++)
				{
					RAM32X4S_replacement.addNet(wire[i]);
				}
				for(int i=0; i<NETNUM; i++)
				{
					RAM32X4S_replacement.addNet(net[i]);
				}
				for(int i=0; i<ENUM; i++)
				{
					RAM32X4S_replacement.addNet(e[i]);
				}
				...
				EdifCellInstance WE_ibuf = new EdifCellInstance("WE_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance D0_ibuf = new EdifCellInstance("D0_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance D1_ibuf = new EdifCellInstance("D1_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance D2_ibuf = new EdifCellInstance("D2_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance D3_ibuf = new EdifCellInstance("D3_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance WCLK_ibuf = new EdifCellInstance("WCLK_ibuf", RAM32X4S_replacement, BUFGP);
				EdifCellInstance A0_ibuf = new EdifCellInstance("A0_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance A1_ibuf = new EdifCellInstance("A1_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance A2_ibuf = new EdifCellInstance("A2_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance A3_ibuf = new EdifCellInstance("A3_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance A4_ibuf = new EdifCellInstance("A4_ibuf", RAM32X4S_replacement, IBUF);
				EdifCellInstance O0_obuf = new EdifCellInstance("O0_obuf", RAM32X4S_replacement, OBUF);
				EdifCellInstance O1_obuf = new EdifCellInstance("O1_obuf", RAM32X4S_replacement, OBUF);
				EdifCellInstance O2_obuf = new EdifCellInstance("O2_obuf", RAM32X4S_replacement, OBUF);
				EdifCellInstance O3_obuf = new EdifCellInstance("O3_obuf", RAM32X4S_replacement, OBUF);
				//FDEs
				...
				for(int i=0; i<FDENUM; i++)
				{
					...
					FDE_[i] = new EdifCellInstance(fdename, RAM32X4S_replacement, FDE);
				}
				//LUT2s
				...
				for(int i=0; i<LUT2NUM; i++)
				{
					...
					LUT2_[i] = new EdifCellInstance(lut2name, RAM32X4S_replacement, LUT2);
				}
				//LUT3s
				...
				for(int i=0; i<LUT3NUM; i++)
				{
					...
					LUT3_[i] = new EdifCellInstance(lut3name, RAM32X4S_replacement, LUT3);
				}
				//LUT4s
				...
				for(int i=0; i<LUT4NUM; i++)
				{
					...
					LUT4_[i] = new EdifCellInstance(lut4name, RAM32X4S_replacement, LUT4);
				}
				//MUXF5
				...
				for(int i=0; i<MUXF5NUM; i++)
				{
					...
					MUXF5_[i] = new EdifCellInstance(muxf5name, RAM32X4S_replacement, MUXF5);
				}
				//MUXF6
				...
				for(int i=0; i<MUXF6NUM; i++)
				{
					...
					MUXF6_[i] = new EdifCellInstance(muxf6name, RAM32X4S_replacement, MUXF6);
				}
				//Add all instances to the top level design
				RAM32X4S_replacement.addSubCell(WE_ibuf);
				RAM32X4S_replacement.addSubCell(D0_ibuf);
				RAM32X4S_replacement.addSubCell(D1_ibuf);
				RAM32X4S_replacement.addSubCell(D2_ibuf);
				RAM32X4S_replacement.addSubCell(D3_ibuf);
				RAM32X4S_replacement.addSubCell(WCLK_ibuf);
				RAM32X4S_replacement.addSubCell(A0_ibuf);
				RAM32X4S_replacement.addSubCell(A1_ibuf);
				RAM32X4S_replacement.addSubCell(A2_ibuf);
				RAM32X4S_replacement.addSubCell(A3_ibuf);
				RAM32X4S_replacement.addSubCell(A4_ibuf);
				RAM32X4S_replacement.addSubCell(O0_obuf);
				RAM32X4S_replacement.addSubCell(O1_obuf);
				RAM32X4S_replacement.addSubCell(O2_obuf);
				RAM32X4S_replacement.addSubCell(O3_obuf);
				for(int i=0; i<FDENUM; i++)
				{
					RAM32X4S_replacement.addSubCell(FDE_[i]);
				}
				for(int i=0; i<LUT2NUM; i++)
				{
					RAM32X4S_replacement.addSubCell(LUT2_[i]);
				}
				for(int i=0; i<LUT3NUM; i++)
				{
					RAM32X4S_replacement.addSubCell(LUT3_[i]);
				}
				for(int i=0; i<LUT4NUM; i++)
				{
					RAM32X4S_replacement.addSubCell(LUT4_[i]);
				}
				for(int i=0; i<MUXF5NUM; i++)
				{
					RAM32X4S_replacement.addSubCell(MUXF5_[i]);
				}
				for(int i=0; i<MUXF6NUM; i++)
				{
					RAM32X4S_replacement.addSubCell(MUXF6_[i]);
				}
				
				/******Interface******/
				//Interface of buffers
				EdifCellInterface RAM32X4S_replacement_interface = new EdifCellInterface(RAM32X4S_replacement);
				...
				/******Ports******/
				//RAM32X4S_replacement
				EdifPort RAM32X4S_replacement_interface_WE = new EdifPort(RAM32X4S_replacement_interface, "WE", 1, 1);
				EdifPort RAM32X4S_replacement_interface_D0 = new EdifPort(RAM32X4S_replacement_interface, "D0", 1, 1);
				EdifPort RAM32X4S_replacement_interface_D1 = new EdifPort(RAM32X4S_replacement_interface, "D1", 1, 1);
				EdifPort RAM32X4S_replacement_interface_D2 = new EdifPort(RAM32X4S_replacement_interface, "D2", 1, 1);
				EdifPort RAM32X4S_replacement_interface_D3 = new EdifPort(RAM32X4S_replacement_interface, "D3", 1, 1);
				EdifPort RAM32X4S_replacement_interface_WCLK = new EdifPort(RAM32X4S_replacement_interface, "WCLK", 1, 1);
				EdifPort RAM32X4S_replacement_interface_A0 = new EdifPort(RAM32X4S_replacement_interface, "A0", 1, 1);
				EdifPort RAM32X4S_replacement_interface_A1 = new EdifPort(RAM32X4S_replacement_interface, "A1", 1, 1);
				EdifPort RAM32X4S_replacement_interface_A2 = new EdifPort(RAM32X4S_replacement_interface, "A2", 1, 1);
				EdifPort RAM32X4S_replacement_interface_A3 = new EdifPort(RAM32X4S_replacement_interface, "A3", 1, 1);
				EdifPort RAM32X4S_replacement_interface_A4 = new EdifPort(RAM32X4S_replacement_interface, "A4", 1, 1);
				EdifPort RAM32X4S_replacement_interface_O0 = new EdifPort(RAM32X4S_replacement_interface, "O0", 1, 2);
				EdifPort RAM32X4S_replacement_interface_O1 = new EdifPort(RAM32X4S_replacement_interface, "O1", 1, 2);
				EdifPort RAM32X4S_replacement_interface_O2 = new EdifPort(RAM32X4S_replacement_interface, "O2", 1, 2);
				EdifPort RAM32X4S_replacement_interface_O3 = new EdifPort(RAM32X4S_replacement_interface, "O3", 1, 2);
				RAM32X4S_replacement_interface.addPort("WE", 1, 1);
				RAM32X4S_replacement_interface.addPort("D0", 1, 1);
				RAM32X4S_replacement_interface.addPort("D1", 1, 1);
				RAM32X4S_replacement_interface.addPort("D2", 1, 1);
				RAM32X4S_replacement_interface.addPort("D3", 1, 1);
				RAM32X4S_replacement_interface.addPort("WCLK", 1, 1);
				RAM32X4S_replacement_interface.addPort("A0", 1, 1);
				RAM32X4S_replacement_interface.addPort("A1", 1, 1);
				RAM32X4S_replacement_interface.addPort("A2", 1, 1);
				RAM32X4S_replacement_interface.addPort("A3", 1, 1);
				RAM32X4S_replacement_interface.addPort("A4", 1, 1);
				RAM32X4S_replacement_interface.addPort("O0", 1, 2);
				RAM32X4S_replacement_interface.addPort("O1", 1, 2);
				RAM32X4S_replacement_interface.addPort("O2", 1, 2);
				RAM32X4S_replacement_interface.addPort("O3", 1, 2);
				//WE_ibuf
				...
				EdifPortRef RAM32X4S_replacement_WE = new EdifPortRef(we, RAM32X4S_replacement_interface_WE.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_D0 = new EdifPortRef(d0, RAM32X4S_replacement_interface_D0.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_D1 = new EdifPortRef(d1, RAM32X4S_replacement_interface_D1.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_D2 = new EdifPortRef(d2, RAM32X4S_replacement_interface_D2.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_D3 = new EdifPortRef(d3, RAM32X4S_replacement_interface_D3.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_WCLK = new EdifPortRef(wclk, RAM32X4S_replacement_interface_WCLK.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_A0 = new EdifPortRef(a0, RAM32X4S_replacement_interface_A0.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_A1 = new EdifPortRef(a1, RAM32X4S_replacement_interface_A1.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_A2 = new EdifPortRef(a2, RAM32X4S_replacement_interface_A2.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_A3 = new EdifPortRef(a3, RAM32X4S_replacement_interface_A3.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_A4 = new EdifPortRef(a4, RAM32X4S_replacement_interface_A4.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_O0 = new EdifPortRef(o0, RAM32X4S_replacement_interface_O0.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_O1 = new EdifPortRef(o1, RAM32X4S_replacement_interface_O1.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_O2 = new EdifPortRef(o2, RAM32X4S_replacement_interface_O2.getSingleBitPort(0), null);
				EdifPortRef RAM32X4S_replacement_O3 = new EdifPortRef(o3, RAM32X4S_replacement_interface_O3.getSingleBitPort(0), null);
				...
				//we
				we.addPortConnection(RAM32X4S_replacement_WE);
				...
				//d0
				d0.addPortConnection(RAM32X4S_replacement_D0);
				...
				//d1
				d1.addPortConnection(RAM32X4S_replacement_D1);
				...
				//d2
				d2.addPortConnection(RAM32X4S_replacement_D2);
				...
				//d3
				d3.addPortConnection(RAM32X4S_replacement_D3);
				...
				wclk.addPortConnection(RAM32X4S_replacement_WCLK);
				//wclk_c
				...
				//a0
				a0.addPortConnection(RAM32X4S_replacement_A0);
				...
				//a1
				a1.addPortConnection(RAM32X4S_replacement_A1);
				...
				//a2
				a2.addPortConnection(RAM32X4S_replacement_A2);
				...
				//a3
				a3.addPortConnection(RAM32X4S_replacement_A3);
				...
				//a4
				a4.addPortConnection(RAM32X4S_replacement_A4);
	...
	public static void Replace(EdifLibraryManager libManager, EdifCell RAM32X4S_replacement, 
			long INIT_00, long INIT_01, long INIT_02, long INIT_03,
			EdifNet we, EdifNet d0, EdifNet d1, EdifNet d2, EdifNet d3, EdifNet wclk, 
			EdifNet a0, EdifNet a1, EdifNet a2, EdifNet a3, EdifNet a4, EdifNet o0, EdifNet o1, EdifNet o2, EdifNet o3) {
		try{
			try{
				/******Cells******/
