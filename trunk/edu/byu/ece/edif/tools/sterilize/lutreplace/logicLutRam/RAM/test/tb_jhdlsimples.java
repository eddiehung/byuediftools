...
/**
 *
 * Testbench used to compare a single logic implementation of a RAMX1S
 * with a single Xilinx RAMX1S primitive.
 *
...
public class tb_jhdlsimples extends Logic implements TestBench {
    ...
    public tb_jhdlsimples(Node parent) {
        ...
        clockDriver(clk, "01");
        jhdlsimpletests logicram = new jhdlsimpletests(this, 
                                                       indata,
                                                       we,
                                                       clk,
                                                       ra,
