...
public class jhdlramtest extends Logic {
    ...
    public jhdlramtest(Node parent,
                       Wire indata,
                       Wire we,
                       Wire clk,
                       Wire wa,
        ...
        new byucc.jhdl.Xilinx.Virtex2.ram128x1s(this, indata.gw(0), we, ra.range(6, 0), 
                                                r128x1s, clk, init32[3]+init32[2]+init32[1]+init32[0]);
        new byucc.jhdl.Xilinx.Virtex2.ram128x1s_1(this, indata.gw(0), we, ra.range(6, 0), r128x1s1, clk,
                                                  init32[3]+init32[2]+init32[1]+init32[0]);
