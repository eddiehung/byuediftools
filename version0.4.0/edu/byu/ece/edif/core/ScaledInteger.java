 ...
 * 
 * @version $Id:ScaledInteger.java 198 2008-04-16 21:14:21Z jamesfcarroll $
 */
public class ScaledInteger implements EdifTypedValue {

    /**
     * Construct an IntegerTypedValue Object with an intitial value as the
     * passed-in value.
     * 
    ...
    public boolean equals(EdifTypedValue value) {
        if (!(value instanceof ScaledInteger))
            return false;
        return _integerValue == ((ScaledInteger) value)._integerValue;
    }
