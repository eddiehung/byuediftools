...
import edu.byu.ece.edif.tools.sterilize.lutreplace.logicLutRam.RAM.test.jhdlramtest;
import edu.byu.ece.edif.tools.sterilize.lutreplace.logicLutRam.SRL.test.jhdlsrltest;
...
public class alljhdltest extends Logic {
    public static CellInterface cell_interface[] = {
            ...
            //out("o32x4s", 4),
            //out("o32x8s", 8),
            out("o64x1d", 2), out("o64x1d1", 2), out("o64x1s", 1), out("o64x1s1", 1), out("o64x2s", 2),
            out("o128x1s", 1), out("o128x1s1", 1),
    ...
    public alljhdltest(
        ...
        new jhdlramtest(this, indata, we, clk, wa, ra, o16x1d, o16x1d1, o16x1s, o16x1s1,
        //o16x2d,
                //o16x2s,
                //o16x4d,
                //o16x4s,
        ...
        new jhdlsrltest(this, indata.gw(0), ce, clk, ra.range(3, 0), osrl16, osrl161, osrl16e, osrl16e1, osrlc16,
