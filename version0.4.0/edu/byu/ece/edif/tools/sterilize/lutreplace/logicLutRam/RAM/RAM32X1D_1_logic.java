/*
 * Logic implementation of a RAM32X1D_1
 * 
...
public class RAM32X1D_1_logic extends Logic {
    public static CellInterface cell_interface[] = { in("WE", 1), in("D", 1), in("WCLK", 1), in("A0", 1), in("A1", 1),
            ...
            in("DPRA4", 1), out("SPO", 1), out("DPO", 1), };

    protected boolean cellInterfaceDeterminesUniqueNetlistStructure() {
        return true;
    }

    public RAM32X1D_1_logic(Node parent, Wire we, Wire d, Wire wclk, Wire a0, Wire a1, Wire a2, Wire a3, Wire a4,
            Wire dpra0, Wire dpra1, Wire dpra2, Wire dpra3, Wire dpra4, Wire spo, Wire dpo, int init) {
        super(parent);
