...
import edu.byu.ece.edif.tools.sterilize.lutreplace.logicLutRam.RAM.test.jhdlmultiramtest;
import edu.byu.ece.edif.tools.sterilize.lutreplace.logicLutRam.SRL.test.jhdlmultisrltest;

/**
 * Instances all JHDL RAMs and SRLs.
 * 
 * @author Nathan Rollins
 * @version $Id:alljhdlmultitest.java 198 2008-04-16 21:14:21Z jamesfcarroll $
 */

public class alljhdlmultitest extends Logic {
    public static CellInterface cell_interface[] = {
            ...
            //out("o32x4s", 4),
            //out("o32x8s", 8),
            out("o64x1d", 6), out("o64x1d1", 6), out("o64x1s", 3), out("o64x1s1", 3), out("o64x2s", 6),
            out("o128x1s", 3), out("o128x1s1", 3),

            out("osrl16", 3), out("osrl161", 3), out("osrl16e", 3), out("osrl16e1", 3), out("osrlc16", 6),
            out("osrlc161", 6), out("osrlc16e", 6), out("osrlc16e1", 6), };

    public alljhdlmultitest(
            Node parent,
            Wire indata,
            Wire ce,
            Wire we,
        ...
        new jhdlmultiramtest(this, indata, we, clk, wa, ra, o16x1d, o16x1d1, o16x1s, o16x1s1,
        //o16x2d,
                //o16x2s,
                //o16x4d,
                //o16x4s,
                //o16x8d,
                //o16x8s,
                o32x1d, o32x1d1, o32x1s, o32x1s1,
                //o32x2s,
                //o32x4s,
                //o32x8s,
                o64x1d, o64x1d1, o64x1s, o64x1s1, o64x2s, o128x1s, o128x1s1);

        // instance all JHDL SRLs
        new jhdlmultisrltest(this, indata.gw(0), ce, clk, ra.range(3, 0), osrl16, osrl161, osrl16e, osrl16e1, osrlc16,
